...
namespace FormGent\DI\Compiler;

use function chmod;
use FormGent\DI\Definition\ArrayDefinition;
use FormGent\DI\Definition\DecoratorDefinition;
...
use FormGent\DI\Definition\Source\DefinitionSource;
use FormGent\DI\Definition\StringDefinition;
use FormGent\DI\Definition\ValueDefinition;
use FormGent\DI\DependencyException;
use FormGent\DI\Proxy\ProxyFactory;
use function dirname;
use function file_put_contents;
use InvalidArgumentException;
use FormGent\Laravel\SerializableClosure\Support\ReflectionClosure;
use function rename;
