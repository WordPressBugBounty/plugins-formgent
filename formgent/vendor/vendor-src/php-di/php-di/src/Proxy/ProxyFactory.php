...
namespace FormGent\DI\Proxy;

use FormGent\ProxyManager\Configuration;
use FormGent\ProxyManager\Factory\LazyLoadingValueHolderFactory;
use FormGent\ProxyManager\FileLocator\FileLocator;
use FormGent\ProxyManager\GeneratorStrategy\EvaluatingGeneratorStrategy;
use FormGent\ProxyManager\GeneratorStrategy\FileWriterGeneratorStrategy;
use FormGent\ProxyManager\Proxy\LazyLoadingInterface;
/**
