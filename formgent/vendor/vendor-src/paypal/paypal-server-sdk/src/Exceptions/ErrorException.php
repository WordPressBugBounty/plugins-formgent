 ...
 */
namespace FormGent\PaypalServerSdkLib\Exceptions;
...
class ErrorException extends ApiException
{
     ...
     */
    public function __construct(string $reason, \FormGent\PaypalServerSdkLib\Http\HttpRequest $request, \FormGent\PaypalServerSdkLib\Http\HttpResponse $response, string $name, string $messageProperty, string $debugId)
    {
    ...
    {
        return ApiHelper::stringify('ErrorException', ['name' => $this->name, 'messageProperty' => $this->messageProperty, 'debugId' => $this->debugId, 'details' => $this->details, 'links' => $this->links], parent::__toString());
    }
}
