...
class OAuthProviderException extends ApiException
{
     ...
     * @param string $error
     */
    public function __construct(string $reason, \FormGent\PaypalServerSdkLib\Http\HttpRequest $request, \FormGent\PaypalServerSdkLib\Http\HttpResponse $response, string $error)
    {
    ...
    {
        return ApiHelper::stringify('OAuthProviderException', ['error' => $this->error, 'errorDescription' => $this->errorDescription, 'errorUri' => $this->errorUri], parent::__toString());
    }
}
