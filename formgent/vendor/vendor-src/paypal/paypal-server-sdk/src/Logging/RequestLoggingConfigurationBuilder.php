...
use FormGent\Core\Logger\Configuration\RequestConfiguration;
...
class RequestLoggingConfigurationBuilder
{
    ...
    {
        return ['includeQueryInPath' => $this->includeQueryInPath, 'body' => $this->body, 'headers' => $this->headers, 'includeHeaders' => CoreHelper::clone($this->includeHeaders), 'excludeHeaders' => CoreHelper::clone($this->excludeHeaders), 'unmaskHeaders' => CoreHelper::clone($this->unmaskHeaders)];
    }
    public function build() : RequestConfiguration
    {
        return new RequestConfiguration($this->includeQueryInPath, $this->body, $this->headers, $this->includeHeaders, $this->excludeHeaders, $this->unmaskHeaders);
    }
}
