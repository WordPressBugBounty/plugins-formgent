...
use FormGent\Core\ClientBuilder;
use FormGent\Core\Utils\CoreHelper;
use FormGent\PaypalServerSdkLib\Authentication\ClientCredentialsAuthCredentialsBuilder;
use FormGent\PaypalServerSdkLib\Authentication\ClientCredentialsAuthManager;
use FormGent\PaypalServerSdkLib\Controllers\OAuthAuthorizationController;
use FormGent\PaypalServerSdkLib\Controllers\OrdersController;
use FormGent\PaypalServerSdkLib\Controllers\PaymentsController;
use FormGent\PaypalServerSdkLib\Controllers\VaultController;
use FormGent\PaypalServerSdkLib\Logging\LoggingConfigurationBuilder;
use FormGent\PaypalServerSdkLib\Logging\RequestLoggingConfigurationBuilder;
use FormGent\PaypalServerSdkLib\Logging\ResponseLoggingConfigurationBuilder;
use FormGent\PaypalServerSdkLib\Utils\CompatibilityConverter;
use FormGent\Unirest\Configuration;
use FormGent\Unirest\HttpClient;
class PaypalServerSdkClient implements ConfigurationInterface
{
    ...
    {
        if (empty($this->clientCredentialsAuthManager->getOAuthClientId()) && empty($this->clientCredentialsAuthManager->getOAuthClientSecret())) {
            return null;
        }
        return ClientCredentialsAuthCredentialsBuilder::init($this->clientCredentialsAuthManager->getOAuthClientId(), $this->clientCredentialsAuthManager->getOAuthClientSecret())->oAuthToken($this->clientCredentialsAuthManager->getOAuthToken());
    }
     ...
     * @var array
     */
    private const ENVIRONMENT_MAP = [Environment::PRODUCTION => [Server::DEFAULT_ => 'https://api-m.paypal.com'], Environment::SANDBOX => [Server::DEFAULT_ => 'https://api-m.sandbox.paypal.com']];
}
