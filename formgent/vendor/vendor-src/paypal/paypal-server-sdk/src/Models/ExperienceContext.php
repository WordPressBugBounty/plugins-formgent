...
class ExperienceContext implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('ExperienceContext', ['brandName' => $this->brandName, 'locale' => $this->locale, 'shippingPreference' => $this->shippingPreference, 'returnUrl' => $this->returnUrl, 'cancelUrl' => $this->cancelUrl]);
    }
    /**
