...
class VaultExperienceContext implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('VaultExperienceContext', ['brandName' => $this->brandName, 'locale' => $this->locale, 'returnUrl' => $this->returnUrl, 'cancelUrl' => $this->cancelUrl, 'shippingPreference' => $this->shippingPreference, 'vaultInstruction' => $this->vaultInstruction]);
    }
    /**
