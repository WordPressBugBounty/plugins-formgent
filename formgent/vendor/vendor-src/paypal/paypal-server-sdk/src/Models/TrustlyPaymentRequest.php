...
class TrustlyPaymentRequest implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('TrustlyPaymentRequest', ['name' => $this->name, 'countryCode' => $this->countryCode, 'email' => $this->email, 'experienceContext' => $this->experienceContext]);
    }
    /**
