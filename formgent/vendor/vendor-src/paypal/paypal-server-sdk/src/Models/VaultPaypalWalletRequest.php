...
class VaultPaypalWalletRequest implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('VaultPaypalWalletRequest', ['description' => $this->description, 'usagePattern' => $this->usagePattern, 'shipping' => $this->shipping, 'permitMultiplePaymentTokens' => $this->permitMultiplePaymentTokens, 'usageType' => $this->usageType, 'customerType' => $this->customerType, 'billingPlan' => $this->billingPlan, 'experienceContext' => $this->experienceContext]);
    }
    /**
