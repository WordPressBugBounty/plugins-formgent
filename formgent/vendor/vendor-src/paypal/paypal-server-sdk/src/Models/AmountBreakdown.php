...
class AmountBreakdown implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('AmountBreakdown', ['itemTotal' => $this->itemTotal, 'shipping' => $this->shipping, 'handling' => $this->handling, 'taxTotal' => $this->taxTotal, 'insurance' => $this->insurance, 'shippingDiscount' => $this->shippingDiscount, 'discount' => $this->discount]);
    }
    /**
