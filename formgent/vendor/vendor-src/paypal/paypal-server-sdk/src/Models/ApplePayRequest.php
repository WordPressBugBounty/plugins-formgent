...
class ApplePayRequest implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('ApplePayRequest', ['id' => $this->id, 'name' => $this->name, 'emailAddress' => $this->emailAddress, 'phoneNumber' => $this->phoneNumber, 'decryptedToken' => $this->decryptedToken, 'storedCredential' => $this->storedCredential, 'vaultId' => $this->vaultId, 'attributes' => $this->attributes]);
    }
    /**
