...
class BillingCycle implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('BillingCycle', ['tenureType' => $this->tenureType, 'pricingScheme' => $this->pricingScheme, 'frequency' => $this->frequency, 'totalCycles' => $this->totalCycles, 'sequence' => $this->sequence, 'startDate' => $this->startDate]);
    }
    /**
