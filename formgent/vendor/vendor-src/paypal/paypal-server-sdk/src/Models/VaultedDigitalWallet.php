...
class VaultedDigitalWallet implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('VaultedDigitalWallet', ['description' => $this->description, 'usagePattern' => $this->usagePattern, 'shipping' => $this->shipping, 'permitMultiplePaymentTokens' => $this->permitMultiplePaymentTokens, 'usageType' => $this->usageType, 'customerType' => $this->customerType]);
    }
    /**
