...
class NetworkToken implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('NetworkToken', ['number' => $this->number, 'expiry' => $this->expiry, 'cryptogram' => $this->cryptogram, 'eciFlag' => $this->eciFlag, 'tokenRequestorId' => $this->tokenRequestorId]);
    }
    /**
