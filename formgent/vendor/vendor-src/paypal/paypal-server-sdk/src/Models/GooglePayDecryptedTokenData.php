...
class GooglePayDecryptedTokenData implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('GooglePayDecryptedTokenData', ['messageId' => $this->messageId, 'messageExpiration' => $this->messageExpiration, 'paymentMethod' => $this->paymentMethod, 'card' => $this->card, 'authenticationMethod' => $this->authenticationMethod, 'cryptogram' => $this->cryptogram, 'eciIndicator' => $this->eciIndicator]);
    }
    /**
