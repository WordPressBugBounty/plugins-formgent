...
class CardRequest implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('CardRequest', ['name' => $this->name, 'number' => $this->number, 'expiry' => $this->expiry, 'securityCode' => $this->securityCode, 'billingAddress' => $this->billingAddress, 'attributes' => $this->attributes, 'vaultId' => $this->vaultId, 'singleUseToken' => $this->singleUseToken, 'storedCredential' => $this->storedCredential, 'networkToken' => $this->networkToken, 'experienceContext' => $this->experienceContext]);
    }
    /**
