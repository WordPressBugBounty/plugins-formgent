...
class Refund implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('Refund', ['status' => $this->status, 'statusDetails' => $this->statusDetails, 'id' => $this->id, 'amount' => $this->amount, 'invoiceId' => $this->invoiceId, 'customId' => $this->customId, 'acquirerReferenceNumber' => $this->acquirerReferenceNumber, 'noteToPayer' => $this->noteToPayer, 'sellerPayableBreakdown' => $this->sellerPayableBreakdown, 'payer' => $this->payer, 'links' => $this->links, 'createTime' => $this->createTime, 'updateTime' => $this->updateTime]);
    }
    /**
