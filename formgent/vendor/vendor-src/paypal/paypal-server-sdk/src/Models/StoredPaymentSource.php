...
class StoredPaymentSource implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('StoredPaymentSource', ['paymentInitiator' => $this->paymentInitiator, 'paymentType' => $this->paymentType, 'usage' => $this->usage, 'previousNetworkTransactionReference' => $this->previousNetworkTransactionReference]);
    }
    /**
