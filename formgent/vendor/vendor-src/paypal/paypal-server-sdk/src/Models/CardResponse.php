...
class CardResponse implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('CardResponse', ['name' => $this->name, 'lastDigits' => $this->lastDigits, 'brand' => $this->brand, 'availableNetworks' => $this->availableNetworks, 'type' => $this->type, 'authenticationResult' => $this->authenticationResult, 'attributes' => $this->attributes, 'fromRequest' => $this->fromRequest, 'expiry' => $this->expiry, 'binDetails' => $this->binDetails, 'storedCredential' => $this->storedCredential]);
    }
    /**
