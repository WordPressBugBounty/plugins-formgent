...
class CapturePaymentInstruction implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('CapturePaymentInstruction', ['platformFees' => $this->platformFees, 'disbursementMode' => $this->disbursementMode, 'payeeReceivableFxRateId' => $this->payeeReceivableFxRateId]);
    }
    /**
