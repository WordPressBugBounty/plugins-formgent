...
class SellerPayableBreakdown implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('SellerPayableBreakdown', ['grossAmount' => $this->grossAmount, 'paypalFee' => $this->paypalFee, 'paypalFeeInReceivableCurrency' => $this->paypalFeeInReceivableCurrency, 'netAmount' => $this->netAmount, 'netAmountInReceivableCurrency' => $this->netAmountInReceivableCurrency, 'platformFees' => $this->platformFees, 'netAmountBreakdown' => $this->netAmountBreakdown, 'totalRefundedAmount' => $this->totalRefundedAmount]);
    }
    /**
