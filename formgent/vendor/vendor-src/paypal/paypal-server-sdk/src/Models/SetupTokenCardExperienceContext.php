...
class SetupTokenCardExperienceContext implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('SetupTokenCardExperienceContext', ['brandName' => $this->brandName, 'locale' => $this->locale, 'returnUrl' => $this->returnUrl, 'cancelUrl' => $this->cancelUrl, 'vaultInstruction' => $this->vaultInstruction]);
    }
    /**
