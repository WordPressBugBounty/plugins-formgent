...
class GooglePayRequest implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('GooglePayRequest', ['name' => $this->name, 'emailAddress' => $this->emailAddress, 'phoneNumber' => $this->phoneNumber, 'card' => $this->card, 'decryptedToken' => $this->decryptedToken, 'assuranceDetails' => $this->assuranceDetails]);
    }
    /**
