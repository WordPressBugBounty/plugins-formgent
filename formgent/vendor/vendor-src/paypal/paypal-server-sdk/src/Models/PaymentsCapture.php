...
class PaymentsCapture implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('PaymentsCapture', ['status' => $this->status, 'statusDetails' => $this->statusDetails, 'id' => $this->id, 'amount' => $this->amount, 'invoiceId' => $this->invoiceId, 'customId' => $this->customId, 'networkTransactionReference' => $this->networkTransactionReference, 'sellerProtection' => $this->sellerProtection, 'finalCapture' => $this->finalCapture, 'sellerReceivableBreakdown' => $this->sellerReceivableBreakdown, 'disbursementMode' => $this->disbursementMode, 'links' => $this->links, 'processorResponse' => $this->processorResponse, 'createTime' => $this->createTime, 'updateTime' => $this->updateTime]);
    }
    /**
