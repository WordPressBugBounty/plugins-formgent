...
class CaptureRequest implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('CaptureRequest', ['invoiceId' => $this->invoiceId, 'noteToPayer' => $this->noteToPayer, 'amount' => $this->amount, 'finalCapture' => $this->finalCapture, 'paymentInstruction' => $this->paymentInstruction, 'softDescriptor' => $this->softDescriptor]);
    }
    /**
