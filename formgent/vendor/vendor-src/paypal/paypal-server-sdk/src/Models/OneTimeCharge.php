...
class OneTimeCharge implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('OneTimeCharge', ['setupFee' => $this->setupFee, 'shippingAmount' => $this->shippingAmount, 'taxes' => $this->taxes, 'productPrice' => $this->productPrice, 'subtotal' => $this->subtotal, 'totalAmount' => $this->totalAmount]);
    }
    /**
