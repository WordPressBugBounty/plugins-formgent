...
class BlikExperienceContext implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('BlikExperienceContext', ['brandName' => $this->brandName, 'locale' => $this->locale, 'shippingPreference' => $this->shippingPreference, 'returnUrl' => $this->returnUrl, 'cancelUrl' => $this->cancelUrl, 'consumerIp' => $this->consumerIp, 'consumerUserAgent' => $this->consumerUserAgent]);
    }
    /**
