...
class ShippingDetails implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('ShippingDetails', ['name' => $this->name, 'emailAddress' => $this->emailAddress, 'phoneNumber' => $this->phoneNumber, 'type' => $this->type, 'options' => $this->options, 'address' => $this->address]);
    }
    /**
