...
class ProcessorResponse implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('ProcessorResponse', ['avsCode' => $this->avsCode, 'cvvCode' => $this->cvvCode, 'responseCode' => $this->responseCode, 'paymentAdviceCode' => $this->paymentAdviceCode]);
    }
    /**
