...
class BancontactPaymentObject implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('BancontactPaymentObject', ['name' => $this->name, 'countryCode' => $this->countryCode, 'bic' => $this->bic, 'ibanLastChars' => $this->ibanLastChars, 'cardLastDigits' => $this->cardLastDigits]);
    }
    /**
