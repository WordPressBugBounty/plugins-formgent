...
class PaymentTokenRequestCard implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('PaymentTokenRequestCard', ['name' => $this->name, 'number' => $this->number, 'expiry' => $this->expiry, 'securityCode' => $this->securityCode, 'brand' => $this->brand, 'billingAddress' => $this->billingAddress]);
    }
    /**
