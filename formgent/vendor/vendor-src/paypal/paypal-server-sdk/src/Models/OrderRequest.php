...
class OrderRequest implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('OrderRequest', ['intent' => $this->intent, 'payer' => $this->payer, 'purchaseUnits' => $this->purchaseUnits, 'paymentSource' => $this->paymentSource, 'applicationContext' => $this->applicationContext]);
    }
    /**
