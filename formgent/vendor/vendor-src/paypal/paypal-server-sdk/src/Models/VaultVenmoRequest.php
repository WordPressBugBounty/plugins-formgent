...
class VaultVenmoRequest implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('VaultVenmoRequest', ['description' => $this->description, 'usagePattern' => $this->usagePattern, 'shipping' => $this->shipping, 'permitMultiplePaymentTokens' => $this->permitMultiplePaymentTokens, 'usageType' => $this->usageType, 'customerType' => $this->customerType, 'experienceContext' => $this->experienceContext]);
    }
    /**
