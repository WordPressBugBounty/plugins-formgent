...
class VenmoWalletResponse implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('VenmoWalletResponse', ['emailAddress' => $this->emailAddress, 'accountId' => $this->accountId, 'userName' => $this->userName, 'name' => $this->name, 'phoneNumber' => $this->phoneNumber, 'address' => $this->address, 'attributes' => $this->attributes]);
    }
    /**
