...
class ErrorDetails implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('ErrorDetails', ['field' => $this->field, 'value' => $this->value, 'location' => $this->location, 'issue' => $this->issue, 'links' => $this->links, 'description' => $this->description]);
    }
    /**
