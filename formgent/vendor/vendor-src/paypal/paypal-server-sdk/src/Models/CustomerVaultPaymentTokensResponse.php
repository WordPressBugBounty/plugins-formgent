...
class CustomerVaultPaymentTokensResponse implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('CustomerVaultPaymentTokensResponse', ['totalItems' => $this->totalItems, 'totalPages' => $this->totalPages, 'customer' => $this->customer, 'paymentTokens' => $this->paymentTokens, 'links' => $this->links]);
    }
    /**
