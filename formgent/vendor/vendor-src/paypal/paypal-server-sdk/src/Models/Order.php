...
class Order implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('Order', ['createTime' => $this->createTime, 'updateTime' => $this->updateTime, 'id' => $this->id, 'paymentSource' => $this->paymentSource, 'intent' => $this->intent, 'payer' => $this->payer, 'purchaseUnits' => $this->purchaseUnits, 'status' => $this->status, 'links' => $this->links]);
    }
    /**
