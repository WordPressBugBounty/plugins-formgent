...
class OrderApplicationContext implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('OrderApplicationContext', ['brandName' => $this->brandName, 'locale' => $this->locale, 'landingPage' => $this->landingPage, 'shippingPreference' => $this->shippingPreference, 'userAction' => $this->userAction, 'paymentMethod' => $this->paymentMethod, 'returnUrl' => $this->returnUrl, 'cancelUrl' => $this->cancelUrl, 'storedPaymentSource' => $this->storedPaymentSource]);
    }
    /**
