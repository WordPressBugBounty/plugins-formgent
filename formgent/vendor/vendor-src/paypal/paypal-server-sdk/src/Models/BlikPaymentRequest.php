...
class BlikPaymentRequest implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('BlikPaymentRequest', ['name' => $this->name, 'countryCode' => $this->countryCode, 'email' => $this->email, 'experienceContext' => $this->experienceContext, 'level0' => $this->level0, 'oneClick' => $this->oneClick]);
    }
    /**
