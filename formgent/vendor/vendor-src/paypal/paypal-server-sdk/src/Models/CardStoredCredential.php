...
class CardStoredCredential implements \JsonSerializable
{
     ...
     */
    public function setPreviousNetworkTransactionReference(?NetworkTransactionReference $previousNetworkTransactionReference) : void
    {
    ...
    {
        return ApiHelper::stringify('CardStoredCredential', ['paymentInitiator' => $this->paymentInitiator, 'paymentType' => $this->paymentType, 'usage' => $this->usage, 'previousNetworkTransactionReference' => $this->previousNetworkTransactionReference]);
    }
    /**
