...
class P24PaymentObject implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('P24PaymentObject', ['name' => $this->name, 'email' => $this->email, 'countryCode' => $this->countryCode, 'paymentDescriptor' => $this->paymentDescriptor, 'methodId' => $this->methodId, 'methodDescription' => $this->methodDescription]);
    }
    /**
