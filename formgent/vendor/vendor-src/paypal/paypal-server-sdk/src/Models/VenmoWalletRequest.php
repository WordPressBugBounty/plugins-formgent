...
class VenmoWalletRequest implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('VenmoWalletRequest', ['vaultId' => $this->vaultId, 'emailAddress' => $this->emailAddress, 'experienceContext' => $this->experienceContext, 'attributes' => $this->attributes]);
    }
    /**
