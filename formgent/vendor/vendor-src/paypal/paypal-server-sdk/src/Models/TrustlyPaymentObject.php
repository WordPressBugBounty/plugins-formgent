...
class TrustlyPaymentObject implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('TrustlyPaymentObject', ['name' => $this->name, 'countryCode' => $this->countryCode, 'email' => $this->email, 'bic' => $this->bic, 'ibanLastChars' => $this->ibanLastChars]);
    }
    /**
