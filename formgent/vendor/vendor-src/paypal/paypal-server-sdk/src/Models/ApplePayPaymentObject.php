...
class ApplePayPaymentObject implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('ApplePayPaymentObject', ['id' => $this->id, 'token' => $this->token, 'name' => $this->name, 'emailAddress' => $this->emailAddress, 'phoneNumber' => $this->phoneNumber, 'card' => $this->card, 'attributes' => $this->attributes, 'storedCredential' => $this->storedCredential]);
    }
    /**
