...
class CardCustomerInformation implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('CardCustomerInformation', ['id' => $this->id, 'emailAddress' => $this->emailAddress, 'phone' => $this->phone, 'merchantCustomerId' => $this->merchantCustomerId]);
    }
    /**
