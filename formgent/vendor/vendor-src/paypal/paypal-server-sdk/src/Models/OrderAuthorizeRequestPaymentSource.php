...
class OrderAuthorizeRequestPaymentSource implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('OrderAuthorizeRequestPaymentSource', ['card' => $this->card, 'token' => $this->token, 'paypal' => $this->paypal, 'applePay' => $this->applePay, 'googlePay' => $this->googlePay, 'venmo' => $this->venmo]);
    }
    /**
