...
class VaultVenmoExperienceContext implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('VaultVenmoExperienceContext', ['brandName' => $this->brandName, 'shippingPreference' => $this->shippingPreference, 'vaultInstruction' => $this->vaultInstruction]);
    }
    /**
