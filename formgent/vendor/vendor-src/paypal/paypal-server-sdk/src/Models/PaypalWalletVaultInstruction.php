...
class PaypalWalletVaultInstruction implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('PaypalWalletVaultInstruction', ['storeInVault' => $this->storeInVault, 'description' => $this->description, 'usagePattern' => $this->usagePattern, 'usageType' => $this->usageType, 'customerType' => $this->customerType, 'permitMultiplePaymentTokens' => $this->permitMultiplePaymentTokens]);
    }
    /**
