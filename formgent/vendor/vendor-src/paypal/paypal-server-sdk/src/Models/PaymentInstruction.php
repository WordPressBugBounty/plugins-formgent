...
class PaymentInstruction implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('PaymentInstruction', ['platformFees' => $this->platformFees, 'disbursementMode' => $this->disbursementMode, 'payeePricingTierId' => $this->payeePricingTierId, 'payeeReceivableFxRateId' => $this->payeeReceivableFxRateId]);
    }
    /**
