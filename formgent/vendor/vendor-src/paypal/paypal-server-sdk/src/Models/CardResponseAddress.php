...
class CardResponseAddress implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('CardResponseAddress', ['addressLine1' => $this->addressLine1, 'addressLine2' => $this->addressLine2, 'adminArea2' => $this->adminArea2, 'adminArea1' => $this->adminArea1, 'postalCode' => $this->postalCode, 'countryCode' => $this->countryCode, 'id' => $this->id]);
    }
    /**
