 ...
 */
class PaymentsProcessorResponse implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    {
        return ApiHelper::stringify('PaymentsProcessorResponse', ['avsCode' => $this->avsCode, 'cvvCode' => $this->cvvCode, 'responseCode' => $this->responseCode, 'paymentAdviceCode' => $this->paymentAdviceCode]);
    }
    /**
