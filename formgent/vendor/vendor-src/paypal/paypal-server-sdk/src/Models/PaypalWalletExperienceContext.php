...
class PaypalWalletExperienceContext implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('PaypalWalletExperienceContext', ['brandName' => $this->brandName, 'locale' => $this->locale, 'shippingPreference' => $this->shippingPreference, 'returnUrl' => $this->returnUrl, 'cancelUrl' => $this->cancelUrl, 'landingPage' => $this->landingPage, 'userAction' => $this->userAction, 'paymentMethodPreference' => $this->paymentMethodPreference, 'orderUpdateCallbackConfig' => $this->orderUpdateCallbackConfig]);
    }
    /**
