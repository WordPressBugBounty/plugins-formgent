...
class SetupTokenRequestCard implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('SetupTokenRequestCard', ['name' => $this->name, 'number' => $this->number, 'expiry' => $this->expiry, 'securityCode' => $this->securityCode, 'brand' => $this->brand, 'billingAddress' => $this->billingAddress, 'verificationMethod' => $this->verificationMethod, 'experienceContext' => $this->experienceContext]);
    }
    /**
