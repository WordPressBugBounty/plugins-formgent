...
class PaymentSource implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('PaymentSource', ['card' => $this->card, 'token' => $this->token, 'paypal' => $this->paypal, 'bancontact' => $this->bancontact, 'blik' => $this->blik, 'eps' => $this->eps, 'giropay' => $this->giropay, 'ideal' => $this->ideal, 'mybank' => $this->mybank, 'p24' => $this->p24, 'sofort' => $this->sofort, 'trustly' => $this->trustly, 'applePay' => $this->applePay, 'googlePay' => $this->googlePay, 'venmo' => $this->venmo]);
    }
    /**
