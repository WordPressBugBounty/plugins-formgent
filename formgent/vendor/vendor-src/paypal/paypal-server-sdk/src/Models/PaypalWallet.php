...
class PaypalWallet implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('PaypalWallet', ['vaultId' => $this->vaultId, 'emailAddress' => $this->emailAddress, 'name' => $this->name, 'phone' => $this->phone, 'birthDate' => $this->birthDate, 'taxInfo' => $this->taxInfo, 'address' => $this->address, 'attributes' => $this->attributes, 'experienceContext' => $this->experienceContext, 'billingAgreementId' => $this->billingAgreementId, 'storedCredential' => $this->storedCredential]);
    }
    /**
