...
class OrderAuthorizeResponsePaymentSource implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('OrderAuthorizeResponsePaymentSource', ['card' => $this->card, 'paypal' => $this->paypal, 'applePay' => $this->applePay, 'googlePay' => $this->googlePay, 'venmo' => $this->venmo]);
    }
    /**
