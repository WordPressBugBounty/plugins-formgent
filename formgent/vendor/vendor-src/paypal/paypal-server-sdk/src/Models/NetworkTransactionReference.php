...
class NetworkTransactionReference implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('NetworkTransactionReference', ['id' => $this->id, 'date' => $this->date, 'network' => $this->network, 'acquirerReferenceNumber' => $this->acquirerReferenceNumber]);
    }
    /**
