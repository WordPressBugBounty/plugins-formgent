...
class PaymentAuthorization implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('PaymentAuthorization', ['status' => $this->status, 'statusDetails' => $this->statusDetails, 'id' => $this->id, 'amount' => $this->amount, 'invoiceId' => $this->invoiceId, 'customId' => $this->customId, 'networkTransactionReference' => $this->networkTransactionReference, 'sellerProtection' => $this->sellerProtection, 'expirationTime' => $this->expirationTime, 'links' => $this->links, 'createTime' => $this->createTime, 'updateTime' => $this->updateTime, 'supplementaryData' => $this->supplementaryData, 'payee' => $this->payee]);
    }
    /**
