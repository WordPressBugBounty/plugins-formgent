 ...
 */
namespace FormGent\PaypalServerSdkLib\Models;

use FormGent\PaypalServerSdkLib\ApiHelper;
use stdClass;
/**
...
class CardPaymentTokenEntity implements \JsonSerializable
{
     ...
     */
    public function setNetworkTransactionReference(?NetworkTransactionReferenceEntity $networkTransactionReference) : void
    {
    ...
    {
        return ApiHelper::stringify('CardPaymentTokenEntity', ['name' => $this->name, 'lastDigits' => $this->lastDigits, 'brand' => $this->brand, 'expiry' => $this->expiry, 'billingAddress' => $this->billingAddress, 'verificationStatus' => $this->verificationStatus, 'verification' => $this->verification, 'networkTransactionReference' => $this->networkTransactionReference, 'authenticationResult' => $this->authenticationResult, 'binDetails' => $this->binDetails, 'type' => $this->type]);
    }
    /**
