...
class SellerReceivableBreakdown implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('SellerReceivableBreakdown', ['grossAmount' => $this->grossAmount, 'paypalFee' => $this->paypalFee, 'paypalFeeInReceivableCurrency' => $this->paypalFeeInReceivableCurrency, 'netAmount' => $this->netAmount, 'receivableAmount' => $this->receivableAmount, 'exchangeRate' => $this->exchangeRate, 'platformFees' => $this->platformFees]);
    }
    /**
