...
class OrderTrackerResponse implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('OrderTrackerResponse', ['id' => $this->id, 'status' => $this->status, 'items' => $this->items, 'links' => $this->links, 'createTime' => $this->createTime, 'updateTime' => $this->updateTime]);
    }
    /**
