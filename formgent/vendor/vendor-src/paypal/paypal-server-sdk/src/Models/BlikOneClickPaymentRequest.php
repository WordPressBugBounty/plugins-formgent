...
class BlikOneClickPaymentRequest implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('BlikOneClickPaymentRequest', ['authCode' => $this->authCode, 'consumerReference' => $this->consumerReference, 'aliasLabel' => $this->aliasLabel, 'aliasKey' => $this->aliasKey]);
    }
    /**
