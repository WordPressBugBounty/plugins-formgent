...
class GooglePayCardResponse implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('GooglePayCardResponse', ['name' => $this->name, 'lastDigits' => $this->lastDigits, 'type' => $this->type, 'brand' => $this->brand, 'billingAddress' => $this->billingAddress, 'authenticationResult' => $this->authenticationResult]);
    }
    /**
