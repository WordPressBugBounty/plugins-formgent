...
class ApplePayTokenizedCard implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('ApplePayTokenizedCard', ['name' => $this->name, 'number' => $this->number, 'expiry' => $this->expiry, 'cardType' => $this->cardType, 'type' => $this->type, 'brand' => $this->brand, 'billingAddress' => $this->billingAddress]);
    }
    /**
