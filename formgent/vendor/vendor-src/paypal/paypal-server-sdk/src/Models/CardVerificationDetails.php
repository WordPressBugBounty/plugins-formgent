...
class CardVerificationDetails implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('CardVerificationDetails', ['networkTransactionId' => $this->networkTransactionId, 'date' => $this->date, 'network' => $this->network, 'time' => $this->time, 'amount' => $this->amount, 'processorResponse' => $this->processorResponse, 'threeDSecure' => $this->threeDSecure]);
    }
    /**
