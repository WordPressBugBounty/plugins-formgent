...
class OrderUpdateCallbackShippingAddress implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('OrderUpdateCallbackShippingAddress', ['adminArea2' => $this->adminArea2, 'adminArea1' => $this->adminArea1, 'postalCode' => $this->postalCode, 'countryCode' => $this->countryCode]);
    }
    /**
