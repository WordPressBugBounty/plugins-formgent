...
class GooglePayCard implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('GooglePayCard', ['name' => $this->name, 'number' => $this->number, 'expiry' => $this->expiry, 'lastDigits' => $this->lastDigits, 'type' => $this->type, 'brand' => $this->brand, 'billingAddress' => $this->billingAddress]);
    }
    /**
