...
class VenmoWalletVaultAttributes implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('VenmoWalletVaultAttributes', ['storeInVault' => $this->storeInVault, 'description' => $this->description, 'usagePattern' => $this->usagePattern, 'usageType' => $this->usageType, 'customerType' => $this->customerType, 'permitMultiplePaymentTokens' => $this->permitMultiplePaymentTokens]);
    }
    /**
