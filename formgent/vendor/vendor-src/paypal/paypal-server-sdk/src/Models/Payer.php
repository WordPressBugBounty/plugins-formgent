...
class Payer implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('Payer', ['emailAddress' => $this->emailAddress, 'payerId' => $this->payerId, 'name' => $this->name, 'phone' => $this->phone, 'birthDate' => $this->birthDate, 'taxInfo' => $this->taxInfo, 'address' => $this->address]);
    }
    /**
