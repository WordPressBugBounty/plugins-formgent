...
class RefundRequest implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('RefundRequest', ['amount' => $this->amount, 'customId' => $this->customId, 'invoiceId' => $this->invoiceId, 'noteToPayer' => $this->noteToPayer, 'paymentInstruction' => $this->paymentInstruction]);
    }
    /**
