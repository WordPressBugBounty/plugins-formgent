...
class PaypalWalletCustomerRequest implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('PaypalWalletCustomerRequest', ['id' => $this->id, 'emailAddress' => $this->emailAddress, 'phone' => $this->phone, 'merchantCustomerId' => $this->merchantCustomerId]);
    }
    /**
