...
class ThreeDSecureCardAuthenticationResponse implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('ThreeDSecureCardAuthenticationResponse', ['authenticationStatus' => $this->authenticationStatus, 'enrollmentStatus' => $this->enrollmentStatus, 'authenticationId' => $this->authenticationId]);
    }
    /**
