...
class OAuthProviderError
{
    ...
    private const _ALL_VALUES = [self::INVALID_REQUEST, self::INVALID_CLIENT, self::INVALID_GRANT, self::UNAUTHORIZED_CLIENT, self::UNSUPPORTED_GRANT_TYPE, self::INVALID_SCOPE];
    /**
