...
class NetAmountBreakdownItem implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('NetAmountBreakdownItem', ['payableAmount' => $this->payableAmount, 'convertedAmount' => $this->convertedAmount, 'exchangeRate' => $this->exchangeRate]);
    }
    /**
