...
class OrderConfirmApplicationContext implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('OrderConfirmApplicationContext', ['brandName' => $this->brandName, 'locale' => $this->locale, 'returnUrl' => $this->returnUrl, 'cancelUrl' => $this->cancelUrl, 'storedPaymentSource' => $this->storedPaymentSource]);
    }
    /**
