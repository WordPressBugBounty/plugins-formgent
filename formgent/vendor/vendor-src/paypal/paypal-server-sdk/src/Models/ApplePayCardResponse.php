...
class ApplePayCardResponse implements \JsonSerializable
{
    ...
    {
        return ApiHelper::stringify('ApplePayCardResponse', ['name' => $this->name, 'lastDigits' => $this->lastDigits, 'brand' => $this->brand, 'availableNetworks' => $this->availableNetworks, 'type' => $this->type, 'authenticationResult' => $this->authenticationResult, 'attributes' => $this->attributes, 'fromRequest' => $this->fromRequest, 'expiry' => $this->expiry, 'binDetails' => $this->binDetails, 'storedCredential' => $this->storedCredential, 'billingAddress' => $this->billingAddress, 'countryCode' => $this->countryCode]);
    }
    /**
