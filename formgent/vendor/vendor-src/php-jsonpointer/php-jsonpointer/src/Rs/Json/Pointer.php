...
namespace FormGent\Rs\Json;

use FormGent\Rs\Json\Pointer\InvalidJsonException;
use FormGent\Rs\Json\Pointer\InvalidPointerException;
use FormGent\Rs\Json\Pointer\NonexistentValueReferencedException;
use FormGent\Rs\Json\Pointer\NonWalkableJsonException;
class Pointer
{
    const POINTER_CHAR = '/';
