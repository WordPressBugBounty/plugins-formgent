...
use FormGent\Google\Auth\Credentials\ExternalAccountCredentials;
use FormGent\Google\Auth\Credentials\ImpersonatedServiceAccountCredentials;
use FormGent\Google\Auth\Credentials\InsecureCredentials;
...
abstract class CredentialsLoader implements GetUniverseDomainInterface, FetchAuthTokenInterface, UpdateMetadataInterface
{
    ...
    public static function makeHttpClient(FetchAuthTokenInterface $fetcher, array $httpClientOptions = [], ?callable $httpHandler = null, ?callable $tokenCallback = null)
    {
        ...
        $stack = \FormGent\GuzzleHttp\HandlerStack::create();
        $stack->push($middleware);
        return new \FormGent\GuzzleHttp\Client(['handler' => $stack, 'auth' => 'google_auth'] + $httpClientOptions);
    }
    /**
