 ...
 */
namespace FormGent\Google\Auth\Credentials;

use FormGent\Google\Auth\CredentialSource\AwsNativeSource;
use FormGent\Google\Auth\CredentialSource\FileSource;
use FormGent\Google\Auth\CredentialSource\UrlSource;
use FormGent\Google\Auth\ExternalAccountCredentialSourceInterface;
use FormGent\Google\Auth\FetchAuthTokenInterface;
use FormGent\Google\Auth\GetQuotaProjectInterface;
use FormGent\Google\Auth\GetUniverseDomainInterface;
use FormGent\Google\Auth\HttpHandler\HttpClientCache;
use FormGent\Google\Auth\HttpHandler\HttpHandlerFactory;
use FormGent\Google\Auth\OAuth2;
use FormGent\Google\Auth\ProjectIdProviderInterface;
use FormGent\Google\Auth\UpdateMetadataInterface;
use FormGent\Google\Auth\UpdateMetadataTrait;
use FormGent\GuzzleHttp\Psr7\Request;
