...
namespace FormGent\Google\AuthHandler;
...
use FormGent\Google\Auth\Middleware\ScopedAccessTokenMiddleware;
use FormGent\Google\Auth\Middleware\SimpleMiddleware;
