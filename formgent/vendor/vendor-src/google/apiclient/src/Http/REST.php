 ...
 */
namespace FormGent\Google\Http;

use FormGent\Google\Auth\HttpHandler\HttpHandlerFactory;
use FormGent\Google\Service\Exception as GoogleServiceException;
use FormGent\Google\Task\Runner;
use FormGent\GuzzleHttp\ClientInterface;
use FormGent\GuzzleHttp\Exception\RequestException;
use FormGent\GuzzleHttp\Psr7\Response;
...
class REST
{
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if (\interface_exists('FormGent\\GuzzleHttp\\Message\\ResponseInterface') && $response instanceof \FormGent\GuzzleHttp\Message\ResponseInterface) {
