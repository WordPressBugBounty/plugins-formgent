 ...
 */
namespace FormGent\Google;

use BadMethodCallException;
use DomainException;
use FormGent\Google\AccessToken\Revoke;
use FormGent\Google\AccessToken\Verify;
use FormGent\Google\Auth\ApplicationDefaultCredentials;
use FormGent\Google\Auth\Cache\MemoryCacheItemPool;
use FormGent\Google\Auth\Credentials\ServiceAccountCredentials;
use FormGent\Google\Auth\Credentials\UserRefreshCredentials;
use FormGent\Google\Auth\CredentialsLoader;
use FormGent\Google\Auth\FetchAuthTokenCache;
use FormGent\Google\Auth\GetUniverseDomainInterface;
use FormGent\Google\Auth\HttpHandler\HttpHandlerFactory;
use FormGent\Google\Auth\OAuth2;
use FormGent\Google\AuthHandler\AuthHandlerFactory;
use FormGent\Google\Http\REST;
use FormGent\GuzzleHttp\Client as GuzzleClient;
use FormGent\GuzzleHttp\ClientInterface;
use FormGent\GuzzleHttp\Ring\Client\StreamHandler;
use InvalidArgumentException;
use LogicException;
use FormGent\Monolog\Handler\StreamHandler as MonologStreamHandler;
use FormGent\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
use FormGent\Monolog\Logger;
use FormGent\Psr\Cache\CacheItemPoolInterface;
...
class Client
{
    ...
    {
        $guzzleVersion = null;
        if (\defined('\FormGent\GuzzleHttp\ClientInterface::MAJOR_VERSION')) {
            $guzzleVersion = ClientInterface::MAJOR_VERSION;
        } elseif (\defined('\FormGent\GuzzleHttp\ClientInterface::VERSION')) {
