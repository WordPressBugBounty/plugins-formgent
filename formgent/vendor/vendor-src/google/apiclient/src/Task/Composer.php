 ...
 * the License.
 */
namespace FormGent\Google\Task;

use FormGent\Composer\Script\Event;
use InvalidArgumentException;
use FormGent\Symfony\Component\Filesystem\Filesystem;
use FormGent\Symfony\Component\Finder\Finder;
class Composer
{
    /**
