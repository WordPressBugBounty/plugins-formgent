...
if (\file_exists(__DIR__ . '/../apiclient/src/Google/Client.php') && !\class_exists('FormGent\\Google_Client', \false)) {
    ...
    if (\defined('Google_Client::LIBVER') && \version_compare(Google_Client::LIBVER, '2.7.2', '<=')) {
        $servicesClassMap = ['FormGent\\Google\\Client' => 'Google_Client', 'FormGent\\Google\\Service' => 'Google_Service', 'FormGent\\Google\\Service\\Resource' => 'Google_Service_Resource', 'FormGent\\Google\\Model' => 'Google_Model', 'FormGent\\Google\\Collection' => 'Google_Collection'];
