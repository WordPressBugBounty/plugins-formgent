...
class RefreshDataSourceObjectExecutionStatus extends \FormGent\Google\Model
{
...
\class_alias(RefreshDataSourceObjectExecutionStatus::class, 'FormGent\\Google_Service_Sheets_RefreshDataSourceObjectExecutionStatus');
