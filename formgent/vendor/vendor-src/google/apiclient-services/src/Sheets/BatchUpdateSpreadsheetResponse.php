...
class BatchUpdateSpreadsheetResponse extends \FormGent\Google\Collection
{
...
\class_alias(BatchUpdateSpreadsheetResponse::class, 'FormGent\\Google_Service_Sheets_BatchUpdateSpreadsheetResponse');
