...
class TreemapChartColorScale extends \FormGent\Google\Model
{
...
\class_alias(TreemapChartColorScale::class, 'FormGent\\Google_Service_Sheets_TreemapChartColorScale');
