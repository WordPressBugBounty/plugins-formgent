...
class DataSourceObjectReference extends \FormGent\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(DataSourceObjectReference::class, 'FormGent\\Google_Service_Sheets_DataSourceObjectReference');
