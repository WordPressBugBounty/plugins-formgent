...
class DeveloperMetadataLocation extends \FormGent\Google\Model
{
...
\class_alias(DeveloperMetadataLocation::class, 'FormGent\\Google_Service_Sheets_DeveloperMetadataLocation');
