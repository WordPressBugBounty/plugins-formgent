...
class UpdateProtectedRangeRequest extends \FormGent\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateProtectedRangeRequest::class, 'FormGent\\Google_Service_Sheets_UpdateProtectedRangeRequest');
