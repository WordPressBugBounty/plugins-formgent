...
class GetSpreadsheetByDataFilterRequest extends \FormGent\Google\Collection
{
...
\class_alias(GetSpreadsheetByDataFilterRequest::class, 'FormGent\\Google_Service_Sheets_GetSpreadsheetByDataFilterRequest');
