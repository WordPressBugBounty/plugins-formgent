...
class AddDimensionGroupResponse extends \FormGent\Google\Collection
{
...
\class_alias(AddDimensionGroupResponse::class, 'FormGent\\Google_Service_Sheets_AddDimensionGroupResponse');
