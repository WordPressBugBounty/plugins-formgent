...
class CandlestickChartSpec extends \FormGent\Google\Collection
{
...
\class_alias(CandlestickChartSpec::class, 'FormGent\\Google_Service_Sheets_CandlestickChartSpec');
