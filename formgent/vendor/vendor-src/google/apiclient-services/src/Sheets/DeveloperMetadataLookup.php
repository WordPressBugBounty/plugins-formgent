...
class DeveloperMetadataLookup extends \FormGent\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DeveloperMetadataLookup::class, 'FormGent\\Google_Service_Sheets_DeveloperMetadataLookup');
