...
class DataSourceChartProperties extends \FormGent\Google\Model
{
...
\class_alias(DataSourceChartProperties::class, 'FormGent\\Google_Service_Sheets_DataSourceChartProperties');
