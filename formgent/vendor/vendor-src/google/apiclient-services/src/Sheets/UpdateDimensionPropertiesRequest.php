...
class UpdateDimensionPropertiesRequest extends \FormGent\Google\Model
{
...
\class_alias(UpdateDimensionPropertiesRequest::class, 'FormGent\\Google_Service_Sheets_UpdateDimensionPropertiesRequest');
