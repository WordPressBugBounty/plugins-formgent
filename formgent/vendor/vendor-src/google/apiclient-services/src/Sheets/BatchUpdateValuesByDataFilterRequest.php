...
class BatchUpdateValuesByDataFilterRequest extends \FormGent\Google\Collection
{
...
\class_alias(BatchUpdateValuesByDataFilterRequest::class, 'FormGent\\Google_Service_Sheets_BatchUpdateValuesByDataFilterRequest');
