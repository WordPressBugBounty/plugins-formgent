...
class UpdateDataSourceResponse extends \FormGent\Google\Model
{
...
\class_alias(UpdateDataSourceResponse::class, 'FormGent\\Google_Service_Sheets_UpdateDataSourceResponse');
