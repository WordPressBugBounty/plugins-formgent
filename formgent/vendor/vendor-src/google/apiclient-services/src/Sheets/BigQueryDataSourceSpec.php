...
class BigQueryDataSourceSpec extends \FormGent\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(BigQueryDataSourceSpec::class, 'FormGent\\Google_Service_Sheets_BigQueryDataSourceSpec');
