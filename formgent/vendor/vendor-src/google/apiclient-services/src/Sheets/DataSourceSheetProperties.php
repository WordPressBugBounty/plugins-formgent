...
class DataSourceSheetProperties extends \FormGent\Google\Collection
{
...
\class_alias(DataSourceSheetProperties::class, 'FormGent\\Google_Service_Sheets_DataSourceSheetProperties');
