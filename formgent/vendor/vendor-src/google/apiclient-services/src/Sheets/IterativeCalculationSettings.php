...
class IterativeCalculationSettings extends \FormGent\Google\Model
{
...
\class_alias(IterativeCalculationSettings::class, 'FormGent\\Google_Service_Sheets_IterativeCalculationSettings');
