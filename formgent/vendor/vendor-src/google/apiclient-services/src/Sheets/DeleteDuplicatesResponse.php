...
class DeleteDuplicatesResponse extends \FormGent\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(DeleteDuplicatesResponse::class, 'FormGent\\Google_Service_Sheets_DeleteDuplicatesResponse');
