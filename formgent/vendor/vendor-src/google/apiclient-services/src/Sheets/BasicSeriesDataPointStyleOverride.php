...
class BasicSeriesDataPointStyleOverride extends \FormGent\Google\Model
{
...
\class_alias(BasicSeriesDataPointStyleOverride::class, 'FormGent\\Google_Service_Sheets_BasicSeriesDataPointStyleOverride');
