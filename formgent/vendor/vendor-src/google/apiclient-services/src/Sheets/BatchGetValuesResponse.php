...
class BatchGetValuesResponse extends \FormGent\Google\Collection
{
...
\class_alias(BatchGetValuesResponse::class, 'FormGent\\Google_Service_Sheets_BatchGetValuesResponse');
