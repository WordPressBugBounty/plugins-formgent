...
class DeleteDuplicatesRequest extends \FormGent\Google\Collection
{
...
\class_alias(DeleteDuplicatesRequest::class, 'FormGent\\Google_Service_Sheets_DeleteDuplicatesRequest');
