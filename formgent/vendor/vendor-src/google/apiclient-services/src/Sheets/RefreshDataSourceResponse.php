...
class RefreshDataSourceResponse extends \FormGent\Google\Collection
{
...
\class_alias(RefreshDataSourceResponse::class, 'FormGent\\Google_Service_Sheets_RefreshDataSourceResponse');
