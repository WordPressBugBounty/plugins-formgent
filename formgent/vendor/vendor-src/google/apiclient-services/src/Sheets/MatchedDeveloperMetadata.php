...
class MatchedDeveloperMetadata extends \FormGent\Google\Collection
{
...
\class_alias(MatchedDeveloperMetadata::class, 'FormGent\\Google_Service_Sheets_MatchedDeveloperMetadata');
