...
class CreateDeveloperMetadataRequest extends \FormGent\Google\Model
{
...
\class_alias(CreateDeveloperMetadataRequest::class, 'FormGent\\Google_Service_Sheets_CreateDeveloperMetadataRequest');
