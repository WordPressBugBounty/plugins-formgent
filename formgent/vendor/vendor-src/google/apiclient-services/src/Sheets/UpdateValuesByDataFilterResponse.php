...
class UpdateValuesByDataFilterResponse extends \FormGent\Google\Model
{
...
\class_alias(UpdateValuesByDataFilterResponse::class, 'FormGent\\Google_Service_Sheets_UpdateValuesByDataFilterResponse');
