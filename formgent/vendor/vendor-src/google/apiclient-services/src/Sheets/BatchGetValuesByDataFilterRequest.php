...
class BatchGetValuesByDataFilterRequest extends \FormGent\Google\Collection
{
...
\class_alias(BatchGetValuesByDataFilterRequest::class, 'FormGent\\Google_Service_Sheets_BatchGetValuesByDataFilterRequest');
