...
class CreateDeveloperMetadataResponse extends \FormGent\Google\Model
{
...
\class_alias(CreateDeveloperMetadataResponse::class, 'FormGent\\Google_Service_Sheets_CreateDeveloperMetadataResponse');
