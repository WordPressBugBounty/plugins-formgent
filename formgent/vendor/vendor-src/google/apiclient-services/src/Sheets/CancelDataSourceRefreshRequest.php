...
class CancelDataSourceRefreshRequest extends \FormGent\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CancelDataSourceRefreshRequest::class, 'FormGent\\Google_Service_Sheets_CancelDataSourceRefreshRequest');
