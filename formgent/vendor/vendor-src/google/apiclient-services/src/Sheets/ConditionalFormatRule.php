...
class ConditionalFormatRule extends \FormGent\Google\Collection
{
...
\class_alias(ConditionalFormatRule::class, 'FormGent\\Google_Service_Sheets_ConditionalFormatRule');
