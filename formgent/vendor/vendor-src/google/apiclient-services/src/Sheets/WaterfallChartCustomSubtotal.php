...
class WaterfallChartCustomSubtotal extends \FormGent\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(WaterfallChartCustomSubtotal::class, 'FormGent\\Google_Service_Sheets_WaterfallChartCustomSubtotal');
