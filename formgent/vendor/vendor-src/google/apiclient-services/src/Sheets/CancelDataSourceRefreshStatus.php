...
class CancelDataSourceRefreshStatus extends \FormGent\Google\Model
{
...
\class_alias(CancelDataSourceRefreshStatus::class, 'FormGent\\Google_Service_Sheets_CancelDataSourceRefreshStatus');
