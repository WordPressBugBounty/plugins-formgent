...
class AddProtectedRangeResponse extends \FormGent\Google\Model
{
...
\class_alias(AddProtectedRangeResponse::class, 'FormGent\\Google_Service_Sheets_AddProtectedRangeResponse');
