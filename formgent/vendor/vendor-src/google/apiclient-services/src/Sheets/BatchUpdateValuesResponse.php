...
class BatchUpdateValuesResponse extends \FormGent\Google\Collection
{
...
\class_alias(BatchUpdateValuesResponse::class, 'FormGent\\Google_Service_Sheets_BatchUpdateValuesResponse');
