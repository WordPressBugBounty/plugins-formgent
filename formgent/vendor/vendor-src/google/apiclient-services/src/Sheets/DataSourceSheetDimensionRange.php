...
class DataSourceSheetDimensionRange extends \FormGent\Google\Collection
{
...
\class_alias(DataSourceSheetDimensionRange::class, 'FormGent\\Google_Service_Sheets_DataSourceSheetDimensionRange');
