...
class DataFilterValueRange extends \FormGent\Google\Collection
{
...
\class_alias(DataFilterValueRange::class, 'FormGent\\Google_Service_Sheets_DataFilterValueRange');
