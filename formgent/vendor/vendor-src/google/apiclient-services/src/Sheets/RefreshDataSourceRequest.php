...
class RefreshDataSourceRequest extends \FormGent\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(RefreshDataSourceRequest::class, 'FormGent\\Google_Service_Sheets_RefreshDataSourceRequest');
