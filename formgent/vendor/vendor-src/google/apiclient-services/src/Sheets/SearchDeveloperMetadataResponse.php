...
class SearchDeveloperMetadataResponse extends \FormGent\Google\Collection
{
...
\class_alias(SearchDeveloperMetadataResponse::class, 'FormGent\\Google_Service_Sheets_SearchDeveloperMetadataResponse');
