...
class UpdateDimensionGroupRequest extends \FormGent\Google\Model
{
...
\class_alias(UpdateDimensionGroupRequest::class, 'FormGent\\Google_Service_Sheets_UpdateDimensionGroupRequest');
