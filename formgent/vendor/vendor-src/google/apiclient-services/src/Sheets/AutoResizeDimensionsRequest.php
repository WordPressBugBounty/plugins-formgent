...
class AutoResizeDimensionsRequest extends \FormGent\Google\Model
{
...
\class_alias(AutoResizeDimensionsRequest::class, 'FormGent\\Google_Service_Sheets_AutoResizeDimensionsRequest');
