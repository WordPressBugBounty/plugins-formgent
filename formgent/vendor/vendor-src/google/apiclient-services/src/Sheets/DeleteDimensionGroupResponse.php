...
class DeleteDimensionGroupResponse extends \FormGent\Google\Collection
{
...
\class_alias(DeleteDimensionGroupResponse::class, 'FormGent\\Google_Service_Sheets_DeleteDimensionGroupResponse');
