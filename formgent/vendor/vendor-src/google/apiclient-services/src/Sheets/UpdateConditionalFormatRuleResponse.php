...
class UpdateConditionalFormatRuleResponse extends \FormGent\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(UpdateConditionalFormatRuleResponse::class, 'FormGent\\Google_Service_Sheets_UpdateConditionalFormatRuleResponse');
