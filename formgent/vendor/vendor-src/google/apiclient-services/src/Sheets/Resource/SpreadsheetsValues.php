 ...
 * the License.
 */
namespace FormGent\Google\Service\Sheets\Resource;

use FormGent\Google\Service\Sheets\AppendValuesResponse;
use FormGent\Google\Service\Sheets\BatchClearValuesByDataFilterRequest;
use FormGent\Google\Service\Sheets\BatchClearValuesByDataFilterResponse;
use FormGent\Google\Service\Sheets\BatchClearValuesRequest;
use FormGent\Google\Service\Sheets\BatchClearValuesResponse;
use FormGent\Google\Service\Sheets\BatchGetValuesByDataFilterRequest;
use FormGent\Google\Service\Sheets\BatchGetValuesByDataFilterResponse;
use FormGent\Google\Service\Sheets\BatchGetValuesResponse;
use FormGent\Google\Service\Sheets\BatchUpdateValuesByDataFilterRequest;
use FormGent\Google\Service\Sheets\BatchUpdateValuesByDataFilterResponse;
use FormGent\Google\Service\Sheets\BatchUpdateValuesRequest;
use FormGent\Google\Service\Sheets\BatchUpdateValuesResponse;
use FormGent\Google\Service\Sheets\ClearValuesRequest;
use FormGent\Google\Service\Sheets\ClearValuesResponse;
use FormGent\Google\Service\Sheets\UpdateValuesResponse;
 ...
 *  </code>
 */
class SpreadsheetsValues extends \FormGent\Google\Service\Resource
{
    /**
...
\class_alias(SpreadsheetsValues::class, 'FormGent\\Google_Service_Sheets_Resource_SpreadsheetsValues');
