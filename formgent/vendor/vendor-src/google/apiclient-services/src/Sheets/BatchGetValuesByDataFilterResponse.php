...
class BatchGetValuesByDataFilterResponse extends \FormGent\Google\Collection
{
...
\class_alias(BatchGetValuesByDataFilterResponse::class, 'FormGent\\Google_Service_Sheets_BatchGetValuesByDataFilterResponse');
