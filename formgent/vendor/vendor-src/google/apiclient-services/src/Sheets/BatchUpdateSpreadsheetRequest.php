...
class BatchUpdateSpreadsheetRequest extends \FormGent\Google\Collection
{
...
\class_alias(BatchUpdateSpreadsheetRequest::class, 'FormGent\\Google_Service_Sheets_BatchUpdateSpreadsheetRequest');
