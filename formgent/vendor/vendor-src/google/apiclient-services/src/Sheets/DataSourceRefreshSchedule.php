...
class DataSourceRefreshSchedule extends \FormGent\Google\Model
{
...
\class_alias(DataSourceRefreshSchedule::class, 'FormGent\\Google_Service_Sheets_DataSourceRefreshSchedule');
