...
class InsertDimensionRequest extends \FormGent\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(InsertDimensionRequest::class, 'FormGent\\Google_Service_Sheets_InsertDimensionRequest');
