 ...
 * the License.
 */
namespace FormGent\Google\Service\Sheets;

class BatchUpdateValuesByDataFilterResponse extends \FormGent\Google\Collection
{
...
\class_alias(BatchUpdateValuesByDataFilterResponse::class, 'FormGent\\Google_Service_Sheets_BatchUpdateValuesByDataFilterResponse');
