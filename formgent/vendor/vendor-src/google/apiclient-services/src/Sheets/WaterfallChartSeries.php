...
class WaterfallChartSeries extends \FormGent\Google\Collection
{
...
\class_alias(WaterfallChartSeries::class, 'FormGent\\Google_Service_Sheets_WaterfallChartSeries');
