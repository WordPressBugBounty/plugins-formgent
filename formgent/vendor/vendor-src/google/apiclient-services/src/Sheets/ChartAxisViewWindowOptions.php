...
class ChartAxisViewWindowOptions extends \FormGent\Google\Model
{
...
\class_alias(ChartAxisViewWindowOptions::class, 'FormGent\\Google_Service_Sheets_ChartAxisViewWindowOptions');
