...
class EmbeddedObjectPosition extends \FormGent\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(EmbeddedObjectPosition::class, 'FormGent\\Google_Service_Sheets_EmbeddedObjectPosition');
