...
class BatchUpdateValuesRequest extends \FormGent\Google\Collection
{
...
\class_alias(BatchUpdateValuesRequest::class, 'FormGent\\Google_Service_Sheets_BatchUpdateValuesRequest');
