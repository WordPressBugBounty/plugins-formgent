...
class DeleteDeveloperMetadataResponse extends \FormGent\Google\Collection
{
...
\class_alias(DeleteDeveloperMetadataResponse::class, 'FormGent\\Google_Service_Sheets_DeleteDeveloperMetadataResponse');
