...
class AddProtectedRangeRequest extends \FormGent\Google\Model
{
...
\class_alias(AddProtectedRangeRequest::class, 'FormGent\\Google_Service_Sheets_AddProtectedRangeRequest');
