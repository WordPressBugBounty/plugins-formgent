...
class UpdateDeveloperMetadataResponse extends \FormGent\Google\Collection
{
...
\class_alias(UpdateDeveloperMetadataResponse::class, 'FormGent\\Google_Service_Sheets_UpdateDeveloperMetadataResponse');
