...
class UpdateDeveloperMetadataRequest extends \FormGent\Google\Collection
{
...
\class_alias(UpdateDeveloperMetadataRequest::class, 'FormGent\\Google_Service_Sheets_UpdateDeveloperMetadataRequest');
