...
class DriveFileImageMediaMetadata extends \FormGent\Google\Model
{
    /**
     * @var float
     */
...
\class_alias(DriveFileImageMediaMetadata::class, 'FormGent\\Google_Service_Drive_DriveFileImageMediaMetadata');
