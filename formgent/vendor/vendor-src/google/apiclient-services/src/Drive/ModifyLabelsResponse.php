...
class ModifyLabelsResponse extends \FormGent\Google\Collection
{
...
\class_alias(ModifyLabelsResponse::class, 'FormGent\\Google_Service_Drive_ModifyLabelsResponse');
