 ...
 * the License.
 */
namespace FormGent\Google\Service\Drive;

class PermissionTeamDrivePermissionDetails extends \FormGent\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(PermissionTeamDrivePermissionDetails::class, 'FormGent\\Google_Service_Drive_PermissionTeamDrivePermissionDetails');
