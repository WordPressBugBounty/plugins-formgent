...
class LabelFieldModification extends \FormGent\Google\Collection
{
...
\class_alias(LabelFieldModification::class, 'FormGent\\Google_Service_Drive_LabelFieldModification');
