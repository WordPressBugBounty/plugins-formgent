...
class DriveFileShortcutDetails extends \FormGent\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DriveFileShortcutDetails::class, 'FormGent\\Google_Service_Drive_DriveFileShortcutDetails');
