...
use FormGent\Google\Service\Drive\App;
use FormGent\Google\Service\Drive\AppList;
/**
 ...
 *  </code>
 */
class Apps extends \FormGent\Google\Service\Resource
{
    /**
...
\class_alias(Apps::class, 'FormGent\\Google_Service_Drive_Resource_Apps');
