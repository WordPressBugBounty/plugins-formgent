...
class DriveFileLinkShareMetadata extends \FormGent\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(DriveFileLinkShareMetadata::class, 'FormGent\\Google_Service_Drive_DriveFileLinkShareMetadata');
