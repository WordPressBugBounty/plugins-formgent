...
namespace FormGent\WhichBrowser\Model;

use FormGent\WhichBrowser\Model\Browser;
use FormGent\WhichBrowser\Model\Engine;
use FormGent\WhichBrowser\Model\Os;
use FormGent\WhichBrowser\Model\Device;
class Main
{
    /**
