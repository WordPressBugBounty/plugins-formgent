...
namespace FormGent\Stripe\Treasury;
 ...
 */
class FinancialAccount extends \FormGent\Stripe\ApiResource
{
    const OBJECT_NAME = 'treasury.financial_account';
    use \FormGent\Stripe\ApiOperations\Update;
    ...
    {
        $url = static::classUrl();
        return static::_requestPage($url, \FormGent\Stripe\Collection::class, $params, $opts);
    }
    /**
    ...
    public function retrieveFeatures($params = null, $opts = null)
    {
        ...
        $obj = \FormGent\Stripe\Util\Util::convertToStripeObject($response, $opts);
        $obj->setLastResponse($response);
        return $obj;
    }
    /**
