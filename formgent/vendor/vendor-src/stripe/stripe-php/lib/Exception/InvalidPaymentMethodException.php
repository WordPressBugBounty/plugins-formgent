...
namespace FormGent\Stripe\Exception;

class InvalidPaymentMethodException extends ApiErrorException
{
    protected $invalidParam;
    public static function factory($message, $httpStatus = null, $httpBody = null, $jsonBody = null, $httpHeaders = null, $stripeCode = null, $invalidParam = null)
    {
