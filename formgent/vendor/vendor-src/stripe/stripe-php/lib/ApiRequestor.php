    ...
    private static function _specificV2APIError($rbody, $rcode, $rheaders, $resp, $errorData)
    {
        ...
        switch ($type) {
            ...
            case 'non_zero_balance':
                return Exception\NonZeroBalanceException::factory($msg, $rcode, $rbody, $resp, $rheaders, $code);
            case 'already_exists':
                return Exception\AlreadyExistsException::factory($msg, $rcode, $rbody, $resp, $rheaders, $code);
            case 'feature_not_enabled':
                return Exception\FeatureNotEnabledException::factory($msg, $rcode, $rbody, $resp, $rheaders, $code);
            case 'financial_account_not_open':
                return Exception\FinancialAccountNotOpenException::factory($msg, $rcode, $rbody, $resp, $rheaders, $code);
            case 'blocked_by_stripe':
                return Exception\BlockedByStripeException::factory($msg, $rcode, $rbody, $resp, $rheaders, $code);
            case 'already_canceled':
                return Exception\AlreadyCanceledException::factory($msg, $rcode, $rbody, $resp, $rheaders, $code);
            case 'not_cancelable':
                return Exception\NotCancelableException::factory($msg, $rcode, $rbody, $resp, $rheaders, $code);
            case 'insufficient_funds':
                return Exception\InsufficientFundsException::factory($msg, $rcode, $rbody, $resp, $rheaders, $code);
            case 'quota_exceeded':
                return Exception\QuotaExceededException::factory($msg, $rcode, $rbody, $resp, $rheaders, $code);
            case 'recipient_not_notifiable':
                return Exception\RecipientNotNotifiableException::factory($msg, $rcode, $rbody, $resp, $rheaders, $code);
            case 'invalid_payout_method':
                return Exception\InvalidPayoutMethodException::factory($msg, $rcode, $rbody, $resp, $rheaders, $code);
            case 'controlled_by_dashboard':
                return Exception\ControlledByDashboardException::factory($msg, $rcode, $rbody, $resp, $rheaders, $code);
            case 'invalid_payment_method':
                $invalidParam = isset($errorData['invalid_param']) ? $errorData['invalid_param'] : null;
                return Exception\InvalidPaymentMethodException::factory($msg, $rcode, $rbody, $resp, $rheaders, $code, $invalidParam);
