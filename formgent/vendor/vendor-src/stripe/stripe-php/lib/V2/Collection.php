 ...
 */
class Collection extends \FormGent\Stripe\StripeObject implements \Countable, \IteratorAggregate
{
    const OBJECT_NAME = 'list';
    use \FormGent\Stripe\ApiOperations\Request;
    /**
     * @return string the base URL for the given class
     */
    public static function baseUrl()
    {
        return \FormGent\Stripe\Stripe::$apiBase;
    }
    /**
     * @return mixed
     */
    ...
    public function offsetGet($k)
    {
        ...
        throw new \FormGent\Stripe\Exception\InvalidArgumentException($msg);
    }
    /**
    ...
    public function autoPagingIterator()
    {
        ...
        while (\true) {
            ...
            $obj = \FormGent\Stripe\Util\Util::convertToStripeObject($response, $opts, 'v2');
