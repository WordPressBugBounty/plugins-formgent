 ...
 */
namespace FormGent\phpseclib3\Common\Functions;

use FormGent\ParagonIE\ConstantTime\Base64;
use FormGent\ParagonIE\ConstantTime\Base64UrlSafe;
use FormGent\ParagonIE\ConstantTime\Hex;
use FormGent\phpseclib3\Math\BigInteger;
use FormGent\phpseclib3\Math\Common\FiniteField;
/**
 * Common String Functions
 *
 * @author  Jim Wigginton <terrafrost@php.net>
