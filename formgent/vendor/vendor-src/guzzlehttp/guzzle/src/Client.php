...
namespace FormGent\GuzzleHttp;

use FormGent\GuzzleHttp\Cookie\CookieJar;
use FormGent\GuzzleHttp\Exception\GuzzleException;
use FormGent\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \FormGent\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
