...
namespace FormGent\WpMVC;

\defined('ABSPATH') || exit;
use FormGent\DI\Container;
use FormGent\WpMVC\Contracts\Provider;
use FormGent\WpMVC\Providers\EnqueueServiceProvider;
use FormGent\WpMVC\Providers\MigrationServiceProvider;
use FormGent\WpMVC\Providers\RouteServiceProvider;
class App
{
