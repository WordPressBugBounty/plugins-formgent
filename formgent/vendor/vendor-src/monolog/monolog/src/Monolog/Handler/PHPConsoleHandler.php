...
use FormGent\Monolog\Formatter\LineFormatter;
use FormGent\Monolog\Formatter\FormatterInterface;
use FormGent\Monolog\Logger;
use FormGent\Monolog\Utils;
use FormGent\PhpConsole\Connector;
use FormGent\PhpConsole\Handler as VendorPhpConsoleHandler;
use FormGent\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('FormGent\\PhpConsole\\Connector')) {
