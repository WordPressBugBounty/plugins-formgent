...
use FormGent\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use FormGent\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
use FormGent\Monolog\Logger;
use FormGent\Monolog\ResettableInterface;
