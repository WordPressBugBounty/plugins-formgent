 ...
 */
namespace FormGent\Monolog\Handler;

use FormGent\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use FormGent\Monolog\Logger;
use FormGent\Monolog\Formatter\FormatterInterface;
use FormGent\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use FormGent\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use FormGent\Elasticsearch\Client;
use FormGent\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use FormGent\Elastic\Elasticsearch\Client as Client8;
/**
