...
class ReportingApi
{
    ...
    protected function getFacebookAdReportRequest($outreach_id, $fields = null, $exclude_fields = null)
    {
        ...
        // path params
        if ($outreach_id !== null) {
            $resourcePath = \str_replace('{' . 'outreach_id' . '}', ObjectSerializer::toPathValue($outreach_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function getSurveyQuestionReportRequest($outreach_id, $question_id, $fields = null, $exclude_fields = null)
    {
        ...
        if ($question_id === null || \is_array($question_id) && \count($question_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $question_id when calling ');
        }
    ...
    protected function getSurveyResponseRequest($outreach_id, $response_id)
    {
        ...
        if ($response_id === null || \is_array($response_id) && \count($response_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $response_id when calling ');
        }
        ...
        // path params
        if ($response_id !== null) {
            $resourcePath = \str_replace('{' . 'response_id' . '}', ObjectSerializer::toPathValue($response_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
