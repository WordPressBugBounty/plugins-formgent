...
class ListsApi
{
    ...
    {
        $this->client = new Client(['defaults' => ['timeout' => 120.0]]);
    ...
    protected function deleteListRequest($list_id)
    {
        ...
        // path params
        if ($list_id !== null) {
            $resourcePath = \str_replace('{' . 'list_id' . '}', ObjectSerializer::toPathValue($list_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
        ...
        if (isset($_tempBody)) {
            ...
            if ($headers['Content-Type'] === 'application/json') {
                if ($httpBody instanceof \stdClass) {
                    $httpBody = \FormGent\GuzzleHttp\json_encode($httpBody);
                }
                if (\is_array($httpBody)) {
                    $httpBody = \FormGent\GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($httpBody));
                }
            }
            ...
            if ($multipart) {
                ...
                $httpBody = \FormGent\GuzzleHttp\json_encode($formParams);
            } else {
    ...
    protected function deleteInterestCategoryRequest($list_id, $interest_category_id)
    {
        ...
        if ($interest_category_id !== null) {
            $resourcePath = \str_replace('{' . 'interest_category_id' . '}', ObjectSerializer::toPathValue($interest_category_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteInterestCategoryInterestRequest($list_id, $interest_category_id, $interest_id)
    {
        ...
        // path params
        if ($interest_id !== null) {
            $resourcePath = \str_replace('{' . 'interest_id' . '}', ObjectSerializer::toPathValue($interest_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteListMemberRequest($list_id, $subscriber_hash)
    {
        ...
        if ($subscriber_hash !== null) {
            $resourcePath = \str_replace('{' . 'subscriber_hash' . '}', ObjectSerializer::toPathValue($subscriber_hash), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteListMemberNoteRequest($list_id, $subscriber_hash, $note_id)
    {
        ...
        // path params
        if ($note_id !== null) {
            $resourcePath = \str_replace('{' . 'note_id' . '}', ObjectSerializer::toPathValue($note_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteListMergeFieldRequest($list_id, $merge_id)
    {
        ...
        // path params
        if ($merge_id !== null) {
            $resourcePath = \str_replace('{' . 'merge_id' . '}', ObjectSerializer::toPathValue($merge_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteSegmentRequest($list_id, $segment_id)
    {
        ...
        // path params
        if ($segment_id !== null) {
            $resourcePath = \str_replace('{' . 'segment_id' . '}', ObjectSerializer::toPathValue($segment_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteListWebhookRequest($list_id, $webhook_id)
    {
        ...
        // path params
        if ($webhook_id !== null) {
            $resourcePath = \str_replace('{' . 'webhook_id' . '}', ObjectSerializer::toPathValue($webhook_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function getListAbuseReportDetailsRequest($list_id, $report_id, $fields = null, $exclude_fields = null, $count = '10', $offset = '0')
    {
        ...
        // path params
        if ($report_id !== null) {
            $resourcePath = \str_replace('{' . 'report_id' . '}', ObjectSerializer::toPathValue($report_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function getListGrowthHistoryByMonthRequest($list_id, $month, $fields = null, $exclude_fields = null)
    {
        ...
        // path params
        if ($month !== null) {
            $resourcePath = \str_replace('{' . 'month' . '}', ObjectSerializer::toPathValue($month), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function getSurveyRequest($list_id, $survey_id)
    {
        ...
        if ($survey_id === null || \is_array($survey_id) && \count($survey_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $survey_id when calling ');
        }
        ...
        // path params
        if ($survey_id !== null) {
            $resourcePath = \str_replace('{' . 'survey_id' . '}', ObjectSerializer::toPathValue($survey_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
