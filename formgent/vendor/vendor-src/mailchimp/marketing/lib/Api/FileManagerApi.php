...
class FileManagerApi
{
    ...
    protected function deleteFileRequest($file_id)
    {
        ...
        // path params
        if ($file_id !== null) {
            $resourcePath = \str_replace('{' . 'file_id' . '}', ObjectSerializer::toPathValue($file_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteFolderRequest($folder_id)
    {
        ...
        // path params
        if ($folder_id !== null) {
            $resourcePath = \str_replace('{' . 'folder_id' . '}', ObjectSerializer::toPathValue($folder_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
