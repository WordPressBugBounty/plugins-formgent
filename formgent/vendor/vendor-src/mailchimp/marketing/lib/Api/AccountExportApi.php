...
class AccountExportApi
{
    ...
    protected function getAccountExportsRequest($export_id, $fields = null, $exclude_fields = null)
    {
        ...
        if ($export_id === null || \is_array($export_id) && \count($export_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $export_id when calling ');
        }
        ...
        // path params
        if ($export_id !== null) {
            $resourcePath = \str_replace('{' . 'export_id' . '}', ObjectSerializer::toPathValue($export_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
