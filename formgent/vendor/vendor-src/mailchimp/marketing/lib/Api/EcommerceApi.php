...
class EcommerceApi
{
    ...
    protected function deleteStoreRequest($store_id)
    {
        ...
        // path params
        if ($store_id !== null) {
            $resourcePath = \str_replace('{' . 'store_id' . '}', ObjectSerializer::toPathValue($store_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteCartLineItemRequest($store_id, $cart_id, $line_id)
    {
        ...
        // path params
        if ($line_id !== null) {
            $resourcePath = \str_replace('{' . 'line_id' . '}', ObjectSerializer::toPathValue($line_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteStoreCustomerRequest($store_id, $customer_id)
    {
        ...
        // path params
        if ($customer_id !== null) {
            $resourcePath = \str_replace('{' . 'customer_id' . '}', ObjectSerializer::toPathValue($customer_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteStoreProductRequest($store_id, $product_id)
    {
        ...
        // path params
        if ($product_id !== null) {
            $resourcePath = \str_replace('{' . 'product_id' . '}', ObjectSerializer::toPathValue($product_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteProductImageRequest($store_id, $product_id, $image_id)
    {
        ...
        // path params
        if ($image_id !== null) {
            $resourcePath = \str_replace('{' . 'image_id' . '}', ObjectSerializer::toPathValue($image_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteProductVariantRequest($store_id, $product_id, $variant_id)
    {
        ...
        // path params
        if ($variant_id !== null) {
            $resourcePath = \str_replace('{' . 'variant_id' . '}', ObjectSerializer::toPathValue($variant_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deletePromoCodeRequest($store_id, $promo_rule_id, $promo_code_id)
    {
        ...
        if ($promo_rule_id !== null) {
            $resourcePath = \str_replace('{' . 'promo_rule_id' . '}', ObjectSerializer::toPathValue($promo_rule_id), $resourcePath);
        }
        // path params
        if ($promo_code_id !== null) {
            $resourcePath = \str_replace('{' . 'promo_code_id' . '}', ObjectSerializer::toPathValue($promo_code_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
