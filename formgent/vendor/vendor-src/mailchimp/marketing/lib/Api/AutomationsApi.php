...
class AutomationsApi
{
    ...
    protected function archiveRequest($workflow_id)
    {
        ...
        // path params
        if ($workflow_id !== null) {
            $resourcePath = \str_replace('{' . 'workflow_id' . '}', ObjectSerializer::toPathValue($workflow_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteWorkflowEmailRequest($workflow_id, $workflow_email_id)
    {
        ...
        if ($workflow_email_id !== null) {
            $resourcePath = \str_replace('{' . 'workflow_email_id' . '}', ObjectSerializer::toPathValue($workflow_email_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
