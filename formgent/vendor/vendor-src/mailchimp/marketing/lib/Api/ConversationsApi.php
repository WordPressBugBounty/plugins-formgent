...
class ConversationsApi
{
    ...
    protected function getRequest($conversation_id, $fields = null, $exclude_fields = null)
    {
        ...
        if ($conversation_id !== null) {
            $resourcePath = \str_replace('{' . 'conversation_id' . '}', ObjectSerializer::toPathValue($conversation_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function getConversationMessageRequest($conversation_id, $message_id, $fields = null, $exclude_fields = null)
    {
        ...
        // path params
        if ($message_id !== null) {
            $resourcePath = \str_replace('{' . 'message_id' . '}', ObjectSerializer::toPathValue($message_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
