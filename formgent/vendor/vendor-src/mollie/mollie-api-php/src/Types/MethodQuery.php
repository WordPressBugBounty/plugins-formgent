...
class MethodQuery
{
    ...
    const INCLUDES = [self::INCLUDE_PRICING, self::INCLUDE_ISSUERS];
    const RESOURCE_ORDERS = 'orders';
    const RESOURCE_PAYMENTS = 'payments';
    const RESOURCES = [self::RESOURCE_ORDERS, self::RESOURCE_PAYMENTS];
    const WALLET_APPLEPAY = 'applepay';
    const WALLET_GOOGLEPAY = 'googlepay';
    const WALLETS = [self::WALLET_APPLEPAY, self::WALLET_GOOGLEPAY];
}
