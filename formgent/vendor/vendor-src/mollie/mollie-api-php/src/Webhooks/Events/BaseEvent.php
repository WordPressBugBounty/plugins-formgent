...
use FormGent\Mollie\Api\Webhooks\WebhookEntity;
use FormGent\Mollie\Api\Webhooks\WebhookSnapshotOrigin;
abstract class BaseEvent
{
    ...
    public function __construct(string $id, string $entityId, DateTime $createdAt, object $links, ?WebhookEntity $entity = null, ?string $signature = null, ?DateTimeImmutable $receivedAt = null)
    {
        $this->id = $id;
    ...
    {
        return $this->entity()->asResource($connector, new WebhookSnapshotOrigin($connector, $this->id, $this->signature, $this->receivedAt));
    }
