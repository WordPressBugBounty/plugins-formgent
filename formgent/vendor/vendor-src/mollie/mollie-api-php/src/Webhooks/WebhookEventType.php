...
class WebhookEventType
{
    ...
    {
        return [self::PAYMENT_LINK_PAID, self::BALANCE_TRANSACTION_CREATED, self::PAYOUT_INITIATED, self::PAYOUT_PROCESSING_AT_BANK, self::PAYOUT_COMPLETED, self::PAYOUT_CANCELED, self::PAYOUT_FAILED, self::CONNECT_BALANCE_TRANSFER_FAILED, self::CONNECT_BALANCE_TRANSFER_SUCCEEDED, self::DISPUTE_CREATED, self::DISPUTE_RESOLVED, self::DISPUTE_UPDATED, self::FILE_ACCEPTED, self::FILE_REJECTED, self::FILE_FAILED, self::UNMATCHED_CREDIT_TRANSFER_RECEIVED, self::UNMATCHED_CREDIT_TRANSFER_MATCHED, self::UNMATCHED_CREDIT_TRANSFER_RETURNED, self::UNMATCHED_CREDIT_TRANSFER_EXPIRED, self::BUSINESS_ACCOUNT_TRANSFER_REQUESTED, self::BUSINESS_ACCOUNT_TRANSFER_INITIATED, self::BUSINESS_ACCOUNT_TRANSFER_PENDING_REVIEW, self::BUSINESS_ACCOUNT_TRANSFER_PROCESSED, self::BUSINESS_ACCOUNT_TRANSFER_FAILED, self::BUSINESS_ACCOUNT_TRANSFER_BLOCKED, self::BUSINESS_ACCOUNT_TRANSFER_RETURNED, self::SALES_INVOICE_CREATED, self::SALES_INVOICE_ISSUED, self::SALES_INVOICE_CANCELED, self::SALES_INVOICE_PAID, self::PROFILE_CREATED, self::PROFILE_VERIFIED, self::PROFILE_BLOCKED, self::PROFILE_DELETED, self::ALL];
    }
}
