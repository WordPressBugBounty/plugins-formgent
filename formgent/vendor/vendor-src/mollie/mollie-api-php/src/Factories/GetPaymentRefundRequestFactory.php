...
use FormGent\Mollie\Api\Http\Requests\GetPaymentRefundRequest;
...
class GetPaymentRefundRequestFactory extends RequestFactory
{
    ...
    public function create() : GetPaymentRefundRequest
    {
        ...
        return new GetPaymentRefundRequest($this->paymentId, $this->refundId, $this->query('includePayment', $includePayment));
    }
}
