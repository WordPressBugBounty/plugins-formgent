...
use FormGent\Mollie\Api\Http\Requests\GetPaginatedSettlementRefundsRequest;
...
class GetPaginatedSettlementRefundsQueryFactory extends RequestFactory
{
    ...
    public function create() : GetPaginatedSettlementRefundsRequest
    {
        ...
        return new GetPaginatedSettlementRefundsRequest($this->settlementId, $this->query('from'), $this->query('limit'), $this->query('includePayment', $includePayment));
    }
}
