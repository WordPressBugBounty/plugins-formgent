...
use FormGent\Mollie\Api\Http\Requests\UpdatePaymentRouteRequest;
class UpdatePaymentRouteRequestFactory extends RequestFactory
{
    ...
    public function create() : UpdatePaymentRouteRequest
    {
        ...
        return new UpdatePaymentRouteRequest($this->paymentId, $this->routeId, $this->transformFromPayload('releaseDate', fn($date) => new Date($date), Date::class));
    }
}
