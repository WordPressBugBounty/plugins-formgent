...
use FormGent\Mollie\Api\Http\Requests\GetPaymentChargebackRequest;
...
class GetPaymentChargebackRequestFactory extends RequestFactory
{
    ...
    public function create() : GetPaymentChargebackRequest
    {
        ...
        return new GetPaymentChargebackRequest($this->paymentId, $this->chargebackId, $this->query('includePayment', $includePayment));
    }
}
