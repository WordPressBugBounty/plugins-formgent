...
use FormGent\Mollie\Api\Http\Requests\GetPaymentRequest;
...
class GetPaymentRequestFactory extends RequestFactory
{
    ...
    public function create() : GetPaymentRequest
    {
        ...
        return new GetPaymentRequest($this->id, $this->query('embedCaptures', $embedCaptures), $this->query('embedRefunds', $embedRefunds), $this->query('embedChargebacks', $embedChargebacks), $this->query('includeQrCode', $includeQrCode), $this->query('includeRemainderDetails', $includeRemainderDetails));
    }
}
