...
use FormGent\Mollie\Api\Http\Requests\CreateDelayedPaymentRouteRequest;
class CreateDelayedPaymentRouteRequestFactory extends RequestFactory
{
    ...
    public function create() : CreateDelayedPaymentRouteRequest
    {
        ...
        return new CreateDelayedPaymentRouteRequest($this->paymentId, $this->transformFromPayload('amount', fn($item) => MoneyFactory::new($item)->create()), $destination);
    }
}
