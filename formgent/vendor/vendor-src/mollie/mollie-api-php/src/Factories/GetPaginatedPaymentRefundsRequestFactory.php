...
use FormGent\Mollie\Api\Http\Requests\GetPaginatedPaymentRefundsRequest;
...
class GetPaginatedPaymentRefundsRequestFactory extends RequestFactory
{
    ...
    public function create() : GetPaginatedPaymentRefundsRequest
    {
        ...
        return new GetPaginatedPaymentRefundsRequest($this->paymentId, $this->query('from'), $this->query('limit'), $this->query('includePayment', $includePayment));
    }
}
