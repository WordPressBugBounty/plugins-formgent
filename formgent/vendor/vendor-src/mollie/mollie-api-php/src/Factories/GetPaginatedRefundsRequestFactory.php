...
use FormGent\Mollie\Api\Http\Requests\GetPaginatedRefundsRequest;
...
class GetPaginatedRefundsRequestFactory extends RequestFactory
{
    public function create() : GetPaginatedRefundsRequest
    {
        ...
        return new GetPaginatedRefundsRequest($this->query('from'), $this->query('limit'), $this->query('embedPayment', $embedPayment), $this->query('profileId'));
    }
}
