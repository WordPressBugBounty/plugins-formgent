...
use FormGent\Mollie\Api\Http\Requests\GetMethodRequest;
...
class GetMethodRequestFactory extends RequestFactory
{
    ...
    public function create() : GetMethodRequest
    {
        ...
        return new GetMethodRequest($this->id, $this->query('locale'), $this->query('currency'), $this->query('profileId'), $this->query('includeIssuers', $includeIssuers));
    }
}
