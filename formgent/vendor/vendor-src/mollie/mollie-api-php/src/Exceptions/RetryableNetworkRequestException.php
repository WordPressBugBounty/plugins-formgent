...
{
    public function __construct(PendingRequest $pendingRequest, ?string $message = null, ?Throwable $previous = null)
    {
        parent::__construct($pendingRequest, $previous, $message ?? 'The request failed due to a temporary network issue. Retrying may resolve this.', ResponseStatusCode::HTTP_SERVICE_UNAVAILABLE);
    }
}
