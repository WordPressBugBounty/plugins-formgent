...
class NetworkRequestException extends MollieException implements NetworkExceptionInterface
{
    ...
    public function __construct(PendingRequest $pendingRequest, ?Throwable $previous = null, ?string $message = null, int $code = ResponseStatusCode::HTTP_GATEWAY_TIMEOUT)
    {
