...
class OrderLine implements Resolvable
{
    ...
    public function __construct(string $description, int $quantity, Money $unitPrice, Money $totalAmount, ?string $type = null, ?string $quantityUnit = null, ?Money $discountAmount = null, ?RecurringBillingCycle $recurring = null, ?string $vatRate = null, ?Money $vatAmount = null, ?string $sku = null, ?string $imageUrl = null, ?string $productUrl = null)
    {
