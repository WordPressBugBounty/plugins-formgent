...
use FormGent\Mollie\Api\Contracts\RequestMiddleware;
...
class ApplyIdempotencyKey implements RequestMiddleware
{
    ...
    public function __invoke(PendingRequest $pendingRequest) : PendingRequest
    {
        ...
        $pendingRequest->headers()->add(self::IDEMPOTENCY_KEY_HEADER, $idempotencyKey ?? $idempotencyKeyGenerator->generate());
        return $pendingRequest;
    }
