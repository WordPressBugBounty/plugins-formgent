...
class CreatePaymentRequest extends ResourceHydratableRequest implements HasPayload, SupportsTestmodeInPayload
{
    ...
    {
        return \array_merge(['description' => $this->description, 'amount' => $this->amount, 'redirectUrl' => $this->redirectUrl, 'cancelUrl' => $this->cancelUrl, 'webhookUrl' => $this->webhookUrl, 'lines' => $this->lines, 'billingAddress' => $this->billingAddress, 'shippingAddress' => $this->shippingAddress, 'locale' => $this->locale, 'method' => $this->paymentMethod, 'issuer' => $this->issuer, 'restrictPaymentMethodsToCountry' => $this->restrictPaymentMethodsToCountry, 'metadata' => $this->metadata, 'captureMode' => $this->captureMode, 'captureDelay' => $this->captureDelay, 'applicationFee' => $this->applicationFee, 'routing' => $this->routing, 'sequenceType' => $this->sequenceType, 'mandateId' => $this->mandateId, 'customerId' => $this->customerId, 'profileId' => $this->profileId], $this->additional);
    }
    protected function defaultQuery() : array
    {
        return ['include' => $this->includeQrCode ? PaymentQuery::INCLUDE_QR_CODE : null];
    }
    /**
     * The resource path.
     */
