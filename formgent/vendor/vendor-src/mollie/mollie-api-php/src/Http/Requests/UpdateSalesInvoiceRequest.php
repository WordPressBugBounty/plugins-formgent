...
use FormGent\Mollie\Api\Http\Data\Recipient;
...
class UpdateSalesInvoiceRequest extends ResourceHydratableRequest implements HasPayload, SupportsTestmodeInPayload
{
    ...
    public function __construct(string $id, ?string $status = null, ?string $recipientIdentifier = null, ?string $memo = null, ?string $paymentTerm = null, ?PaymentDetails $paymentDetails = null, ?EmailDetails $emailDetails = null, ?Recipient $recipient = null, ?DataCollection $lines = null, ?string $webhookUrl = null, ?Discount $discount = null, ?bool $isEInvoice = null)
    {
        $this->id = $id;
        $this->status = $status;
    ...
    {
        return ['status' => $this->status, 'recipientIdentifier' => $this->recipientIdentifier, 'memo' => $this->memo, 'paymentTerm' => $this->paymentTerm, 'paymentDetails' => $this->paymentDetails, 'emailDetails' => $this->emailDetails, 'recipient' => $this->recipient, 'lines' => $this->lines, 'webhookUrl' => $this->webhookUrl, 'discount' => $this->discount, 'isEInvoice' => $this->isEInvoice];
    }
