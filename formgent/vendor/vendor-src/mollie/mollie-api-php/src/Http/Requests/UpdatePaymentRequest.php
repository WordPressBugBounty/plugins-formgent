...
class UpdatePaymentRequest extends ResourceHydratableRequest implements HasPayload, SupportsTestmodeInPayload
{
    ...
    public function __construct(string $id, ?string $description = null, ?string $redirectUrl = null, ?string $cancelUrl = null, ?string $webhookUrl = null, ?array $metadata = null, ?string $method = null, ?string $locale = null, ?string $restrictPaymentMethodsToCountry = null, array $additional = [])
    {
        $this->id = $id;
    ...
    {
        return \array_merge(['description' => $this->description, 'redirectUrl' => $this->redirectUrl, 'cancelUrl' => $this->cancelUrl, 'webhookUrl' => $this->webhookUrl, 'metadata' => $this->metadata, 'method' => $this->paymentMethod, 'locale' => $this->locale, 'restrictPaymentMethodsToCountry' => $this->restrictPaymentMethodsToCountry], $this->additional);
    }
