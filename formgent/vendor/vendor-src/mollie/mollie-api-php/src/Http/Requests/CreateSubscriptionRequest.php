...
class CreateSubscriptionRequest extends ResourceHydratableRequest implements HasPayload, SupportsTestmodeInPayload
{
     ...
     */
    public function __construct(string $customerId, Money $amount, string $interval, string $description, ?string $status = null, ?int $times = null, $startDate = null, ?string $method = null, ?ApplicationFee $applicationFee = null, ?array $metadata = null, ?string $webhookUrl = null, ?string $mandateId = null, ?string $profileId = null)
    {
    ...
    {
        return ['amount' => $this->amount, 'interval' => $this->interval, 'description' => $this->description, 'status' => $this->status, 'times' => $this->times, 'startDate' => $this->startDate, 'method' => $this->paymentMethod, 'applicationFee' => $this->applicationFee, 'metadata' => $this->metadata, 'webhookUrl' => $this->webhookUrl, 'mandateId' => $this->mandateId, 'profileId' => $this->profileId];
    }
    /**
     * The resource path.
     */
