...
class GetPaymentRequest extends ResourceHydratableRequest implements SupportsTestmodeInQuery
{
    ...
    public function __construct(string $id, bool $embedCaptures = \false, bool $embedRefunds = \false, bool $embedChargebacks = \false, bool $includeQrCode = \false, bool $includeRemainderDetails = \false)
    {
        $this->id = $id;
    ...
    {
        return ['embed' => Arr::join([$this->embedCaptures ? PaymentQuery::EMBED_CAPTURES : null, $this->embedRefunds ? PaymentQuery::EMBED_REFUNDS : null, $this->embedChargebacks ? PaymentQuery::EMBED_CHARGEBACKS : null]), 'include' => Arr::join([$this->includeQrCode ? PaymentQuery::INCLUDE_QR_CODE : null, $this->includeRemainderDetails ? PaymentQuery::INCLUDE_REMAINDER_DETAILS : null])];
    }
    /**
