...
class CreateClientLinkRequest extends ResourceHydratableRequest implements HasPayload
{
    ...
    public function __construct(Owner $owner, string $name, OwnerAddress $address, ?string $registrationNumber = null, ?string $vatNumber = null)
    {
        $this->owner = $owner;
        $this->name = $name;
    ...
    {
        return ['owner' => $this->owner, 'name' => $this->name, 'address' => $this->address, 'registrationNumber' => $this->registrationNumber, 'vatNumber' => $this->vatNumber];
    }
