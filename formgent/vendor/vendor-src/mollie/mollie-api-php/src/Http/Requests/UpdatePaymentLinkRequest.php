...
class UpdatePaymentLinkRequest extends ResourceHydratableRequest implements HasPayload, SupportsTestmodeInPayload
{
    ...
    public function __construct(string $id, string $description, bool $archived = \false, ?array $allowedMethods = null, ?DataCollection $lines = null, ?Address $billingAddress = null, ?Address $shippingAddress = null, ?Money $minimumAmount = null)
    {
        $this->id = $id;
    ...
    {
        return ['description' => $this->description, 'archived' => $this->archived, 'allowedMethods' => $this->allowedMethods, 'minimumAmount' => $this->minimumAmount, 'lines' => $this->lines, 'billingAddress' => $this->billingAddress, 'shippingAddress' => $this->shippingAddress];
    }
