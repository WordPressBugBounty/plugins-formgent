...
class UpdateProfileRequest extends ResourceHydratableRequest implements HasPayload
{
    ...
    private ?string $mode;
    public function __construct(string $id, ?string $name = null, ?string $website = null, ?string $email = null, ?string $phone = null, ?string $description = null, ?array $countriesOfActivity = null, ?string $businessCategory = null, ?string $mode = null)
    {
        $this->id = $id;
        $this->name = $name;
    ...
    {
        return ['name' => $this->name, 'website' => $this->website, 'email' => $this->email, 'phone' => $this->phone, 'description' => $this->description, 'countriesOfActivity' => $this->countriesOfActivity, 'businessCategory' => $this->businessCategory, 'mode' => $this->mode];
    }
