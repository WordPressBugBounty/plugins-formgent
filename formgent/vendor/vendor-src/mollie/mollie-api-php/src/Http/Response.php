...
use FormGent\Mollie\Api\Exceptions\JsonParseException;
...
class Response implements ResourceOrigin
{
    ...
    public function __construct(ResponseInterface $psrResponse, RequestInterface $psrRequest, PendingRequest $pendingRequest, ?Throwable $senderException = null)
    {
