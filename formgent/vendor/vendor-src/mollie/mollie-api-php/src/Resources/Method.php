...
class Method extends BaseResource
{
    ...
    public function issuers() : IssuerCollection
    {
        ...
        $collection = ResourceFactory::createCollection($this->connector, IssuerCollection::class);
        if ($this->issuers === null) {
            return $collection;
        }
        /** @var IssuerCollection */
        $collection = (new ResourceHydrator())->hydrateCollection($collection, (array) $this->issuers, $this->getOrigin());
        return $collection;
    }
    /**
    ...
    public function pricing() : MethodPriceCollection
    {
        ...
        $collection = ResourceFactory::createCollection($this->connector, MethodPriceCollection::class);
        if ($this->pricing === null) {
            return $collection;
        }
        /** @var MethodPriceCollection */
        $collection = (new ResourceHydrator())->hydrateCollection($collection, (array) $this->pricing, $this->getOrigin());
        return $collection;
    }
}
