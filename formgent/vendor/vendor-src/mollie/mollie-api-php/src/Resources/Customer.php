...
class Customer extends BaseResource
{
    ...
    {
        return $this->connector->customerPayments->createFor($this, $options, $filters, $this->isInTestmode());
    }
    /**
    ...
    {
        return $this->mandates()->contains(fn(Mandate $mandate) => $mandate->isValid());
    }
    /**
    ...
    {
        return $this->mandates()->contains(fn(Mandate $mandate) => $mandate->isValid() && $mandate->method === $method);
    }
}
