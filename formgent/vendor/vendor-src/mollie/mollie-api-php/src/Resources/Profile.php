...
use FormGent\Mollie\Api\Types\ProfileStatus;
/**
...
class Profile extends BaseResource
{
    ...
    public function chargebacks() : ChargebackCollection
    {
        ...
        return $this->connector->send((new DynamicGetRequest($href, $query))->setHydratableResource(ChargebackCollection::class));
    }
    /**
    ...
    public function methods() : MethodCollection
    {
        ...
        return $this->connector->send((new DynamicGetRequest($href, $query))->setHydratableResource(MethodCollection::class));
    }
    /**
    ...
    public function payments() : PaymentCollection
    {
        ...
        return $this->connector->send((new DynamicGetRequest($href, $query))->setHydratableResource(PaymentCollection::class));
    }
    /**
    ...
    public function refunds() : RefundCollection
    {
        ...
        return $this->connector->send((new DynamicGetRequest($href, $query))->setHydratableResource(RefundCollection::class));
    }
}
