...
use FormGent\Mollie\Api\Contracts\EmbeddedResourcesContract;
use FormGent\Mollie\Api\Exceptions\ApiException;
use FormGent\Mollie\Api\Http\Requests\DynamicGetRequest;
use FormGent\Mollie\Api\Http\Requests\UpdatePaymentRequest;
use FormGent\Mollie\Api\Traits\HasMode;
use FormGent\Mollie\Api\Types\PaymentMethod;
use FormGent\Mollie\Api\Types\PaymentStatus;
...
class Payment extends BaseResource implements EmbeddedResourcesContract
{
    ...
    {
        return ['captures' => CaptureCollection::class, 'refunds' => RefundCollection::class, 'chargebacks' => ChargebackCollection::class];
    }
    /**
    ...
    public function refunds() : RefundCollection
    {
        ...
        return $this->connector->send((new DynamicGetRequest($this->_links->refunds->href))->setHydratableResource(RefundCollection::class));
    }
    /**
    ...
    {
        return $this->connector->paymentRefunds->pageFor($this, null, null, $this->withMode($parameters));
    }
    /**
    ...
    public function captures() : CaptureCollection
    {
        ...
        return $this->connector->send((new DynamicGetRequest($this->_links->captures->href))->setHydratableResource(CaptureCollection::class));
    }
    /**
    ...
    {
        return $this->connector->paymentCaptures->getFor($this, $captureId, $parameters, $this->isInTestmode());
    }
    /**
    ...
    public function chargebacks() : ChargebackCollection
    {
        ...
        return $this->connector->send((new DynamicGetRequest($this->_links->chargebacks->href))->setHydratableResource(ChargebackCollection::class));
    }
    /**
    ...
    {
        return $this->connector->paymentChargebacks->getFor($this, $chargebackId, $parameters, $this->isInTestmode());
    }
    /**
    ...
    public function update() : Payment
    {
        ...
        $updateRequest = (new UpdatePaymentRequest($this->id, $this->description, $this->redirectUrl, $this->cancelUrl, $this->webhookUrl, (array) $this->metadata, $this->method, $this->locale, $this->restrictPaymentMethodsToCountry, $additional))->test($this->isInTestmode());
        /** @var null|Payment */
        return $this->connector->send($updateRequest);
    }
    /**
     * The total amount that is already captured for this payment. Only available
     * when this payment supports captures.
