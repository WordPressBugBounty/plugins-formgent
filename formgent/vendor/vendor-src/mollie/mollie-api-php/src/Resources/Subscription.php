...
use FormGent\Mollie\Api\Types\SubscriptionStatus;
/**
...
class Subscription extends BaseResource
{
    ...
    public function cancel() : ?Subscription
    {
        ...
        return $this->connector->send((new CancelSubscriptionRequest($this->customerId, $this->id))->test($this->mode === 'test'));
    }
    /**
    ...
    public function payments() : PaymentCollection
    {
        ...
        return $this->connector->send((new DynamicGetRequest($this->_links->payments->href))->setHydratableResource(PaymentCollection::class));
    }
}
