...
class ResourceRegistry
{
    ...
    {
        return [Balance::class => 'balances', BalanceReport::class => 'balance-reports', BalanceTransaction::class => 'balance-transactions', Capability::class => 'capabilities', Capture::class => 'captures', Chargeback::class => 'chargebacks', Client::class => 'clients', ClientLink::class => 'client-links', ConnectBalanceTransfer::class => 'connect-balance-transfers', Customer::class => 'customers', Invoice::class => 'invoices', Issuer::class => 'issuers', Mandate::class => 'mandates', Method::class => 'methods', MethodPrice::class => 'method-prices', Onboarding::class => 'onboardings', Organization::class => 'organizations', Partner::class => 'partners', Payment::class => 'payments', PaymentLink::class => 'payment-links', Permission::class => 'permissions', Payout::class => 'payouts', Profile::class => 'profiles', Refund::class => 'refunds', Route::class => 'routes', SalesInvoice::class => 'sales-invoices', Session::class => 'sessions', Settlement::class => 'settlements', Subscription::class => 'subscriptions', Terminal::class => 'terminals', TerminalPairingCode::class => 'terminal-pairing-codes', Webhook::class => 'webhooks', WebhookEvent::class => 'webhook-events'];
    }
    /**
