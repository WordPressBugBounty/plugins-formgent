...
use FormGent\Mollie\Api\Factories\GetPaginatedChargebacksRequestFactory;
...
class ChargebackEndpointCollection extends EndpointCollection
{
    ...
    public function page(?string $from = null, ?int $limit = null, array $filters = []) : ChargebackCollection
    {
        ...
        $request = GetPaginatedChargebacksRequestFactory::new()->withQuery(['from' => $from, 'limit' => $limit, 'filters' => $filters])->create();
