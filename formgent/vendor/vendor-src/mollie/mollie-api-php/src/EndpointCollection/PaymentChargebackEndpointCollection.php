...
use FormGent\Mollie\Api\Factories\GetPaginatedPaymentChargebacksRequestFactory;
use FormGent\Mollie\Api\Factories\GetPaymentChargebackRequestFactory;
use FormGent\Mollie\Api\Resources\Chargeback;
...
class PaymentChargebackEndpointCollection extends EndpointCollection
{
    ...
    public function getForId(string $paymentId, string $chargebackId, array $query = [], bool $testmode = \false) : Chargeback
    {
        ...
        $request = GetPaymentChargebackRequestFactory::new($paymentId, $chargebackId)->withQuery($query)->create();
        /** @var Chargeback */
    ...
    {
        $testmode = Utility::extractBool($query, 'testmode', $testmode);
        $request = GetPaginatedPaymentChargebacksRequestFactory::new($paymentId)->withQuery($query)->create();
    ...
    public function iteratorForId(string $paymentId, ?string $from = null, ?int $limit = null, array $filters = [], bool $iterateBackwards = \false) : LazyCollection
    {
        ...
        $request = GetPaginatedPaymentChargebacksRequestFactory::new($paymentId)->withQuery(['from' => $from, 'limit' => $limit, 'filters' => $filters])->create();
