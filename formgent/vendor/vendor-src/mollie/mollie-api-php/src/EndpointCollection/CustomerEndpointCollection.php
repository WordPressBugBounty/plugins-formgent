...
use FormGent\Mollie\Api\Factories\CreateCustomerRequestFactory;
use FormGent\Mollie\Api\Factories\UpdateCustomerRequestFactory;
use FormGent\Mollie\Api\Http\Requests\DeleteCustomerRequest;
use FormGent\Mollie\Api\Http\Requests\GetCustomerRequest;
use FormGent\Mollie\Api\Http\Requests\GetPaginatedCustomerRequest;
...
class CustomerEndpointCollection extends EndpointCollection
{
    ...
    public function create($data = [], $testmode = \false) : Customer
    {
        ...
        $request = CreateCustomerRequestFactory::new()->withPayload($data)->create();
        /** @var Customer */
    ...
    {
        $request = UpdateCustomerRequestFactory::new($id)->withPayload($data)->create();
        /** @var null|Customer */
    ...
    {
        $testmode = Utility::extractBool($testmode, 'testmode', \false);
        return $this->send((new GetPaginatedCustomerRequest($from, $limit))->useIterator()->setIterationDirection($iterateBackwards)->test($testmode));
    }
}
