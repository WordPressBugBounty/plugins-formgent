...
use FormGent\Mollie\Api\Factories\GetPaginatedSettlementsRequestFactory;
use FormGent\Mollie\Api\Http\Requests\GetSettlementRequest;
...
class SettlementEndpointCollection extends EndpointCollection
{
    ...
    {
        $request = GetPaginatedSettlementsRequestFactory::new()->withQuery(['from' => $from, 'limit' => $limit, 'filters' => $filters])->create();
