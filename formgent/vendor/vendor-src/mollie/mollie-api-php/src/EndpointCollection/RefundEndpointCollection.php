...
use FormGent\Mollie\Api\Factories\GetPaginatedRefundsRequestFactory;
...
class RefundEndpointCollection extends EndpointCollection
{
    ...
    public function page(?string $from = null, ?int $limit = null, array $filters = []) : RefundCollection
    {
        ...
        $request = GetPaginatedRefundsRequestFactory::new()->withQuery(['from' => $from, 'limit' => $limit, 'filters' => $filters])->create();
