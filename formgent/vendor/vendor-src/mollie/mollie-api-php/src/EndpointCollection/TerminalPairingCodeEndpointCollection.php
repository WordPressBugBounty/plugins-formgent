...
use FormGent\Mollie\Api\Http\Requests\GetPaginatedTerminalPairingCodesRequest;
use FormGent\Mollie\Api\Http\Requests\GetTerminalPairingCodeRequest;
use FormGent\Mollie\Api\Http\Requests\RequestTerminalPairingCodeRequest;
use FormGent\Mollie\Api\Http\Requests\RevokeTerminalPairingCodeRequest;
...
class TerminalPairingCodeEndpointCollection extends EndpointCollection
{
     ...
     * @throws RequestException
     */
    public function page(?string $from = null, ?int $limit = null, ?string $sort = null, ?string $profileId = null) : TerminalPairingCodeCollection
    {
     ...
     */
    public function iterator(?string $from = null, ?int $limit = null, ?string $sort = null, ?string $profileId = null, bool $iterateBackwards = \false) : LazyCollection
    {
        return $this->send((new GetPaginatedTerminalPairingCodesRequest($from, $limit, $sort, $profileId))->useIterator()->setIterationDirection($iterateBackwards));
    }
}
