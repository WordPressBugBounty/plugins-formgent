...
use FormGent\Mollie\Api\Factories\GetAllPaymentMethodsRequestFactory;
use FormGent\Mollie\Api\Factories\GetEnabledMethodsRequestFactory;
use FormGent\Mollie\Api\Factories\GetMethodRequestFactory;
...
class MethodEndpointCollection extends EndpointCollection
{
    ...
    {
        $request = GetAllPaymentMethodsRequestFactory::new()->withQuery($query)->create();
    ...
    public function allEnabled(array $query = [], bool $testmode = \false) : MethodCollection
    {
        ...
        $request = GetEnabledMethodsRequestFactory::new()->withQuery($query)->create();
        /** @var MethodCollection */
    ...
    {
        $testmode = Utility::extractBool($query, 'testmode', $testmode);
        $request = GetMethodRequestFactory::new($methodId)->withQuery($query)->create();
        /** @var Method */
        return $this->send($request->test($testmode));
    }
}
