...
use FormGent\Mollie\Api\Factories\CreateDelayedPaymentRouteRequestFactory;
use FormGent\Mollie\Api\Factories\UpdatePaymentRouteRequestFactory;
use FormGent\Mollie\Api\Http\Requests\ListPaymentRoutesRequest;
...
class PaymentRouteEndpointCollection extends EndpointCollection
{
    ...
    public function createForId(string $paymentId, array $amount, array $destination, ?string $releaseDate = null, bool $testmode = \false) : Route
    {
        ...
        $request = CreateDelayedPaymentRouteRequestFactory::new($paymentId)->withPayload($payload)->create();
        /** @var Route */
    ...
    {
        $request = UpdatePaymentRouteRequestFactory::new($paymentId, $routeId)->withPayload(['releaseDate' => $releaseDate])->create();
        /** @var Route */
        return $this->send($request->test($testmode));
    }
}
