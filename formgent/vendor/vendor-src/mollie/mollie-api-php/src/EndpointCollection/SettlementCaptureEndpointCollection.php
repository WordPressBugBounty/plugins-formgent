...
use FormGent\Mollie\Api\Factories\GetPaginatedSettlementCapturesRequestFactory;
...
class SettlementCaptureEndpointCollection extends EndpointCollection
{
    ...
    public function pageForId(string $settlementId, array $query = [], bool $testmode = \false) : CaptureCollection
    {
        ...
        $request = GetPaginatedSettlementCapturesRequestFactory::new($settlementId)->withQuery($query)->create();
    ...
    public function iteratorForId(string $settlementId, ?string $from = null, ?int $limit = null, array $filters = [], bool $iterateBackwards = \false) : LazyCollection
    {
        ...
        $request = GetPaginatedSettlementCapturesRequestFactory::new($settlementId)->withQuery(['from' => $from, 'limit' => $limit, 'filters' => $filters])->create();
