...
use FormGent\Mollie\Api\Factories\GetPaginatedInvoiceRequestFactory;
use FormGent\Mollie\Api\Http\Requests\GetInvoiceRequest;
use FormGent\Mollie\Api\Resources\Invoice;
use FormGent\Mollie\Api\Resources\InvoiceCollection;
...
class InvoiceEndpointCollection extends EndpointCollection
{
    ...
    {
        $request = GetPaginatedInvoiceRequestFactory::new()->withQuery(['from' => $from, 'limit' => $limit, 'filters' => $filters])->create();
