...
use FormGent\Mollie\Api\Factories\GetPaginatedSettlementRefundsQueryFactory;
...
class SettlementRefundEndpointCollection extends EndpointCollection
{
    ...
    public function pageForId(string $settlementId, array $query = [], bool $testmode = \false) : RefundCollection
    {
        ...
        $request = GetPaginatedSettlementRefundsQueryFactory::new($settlementId)->withQuery($query)->create();
    ...
    public function iteratorForId(string $settlementId, ?string $from = null, ?int $limit = null, array $filters = [], bool $iterateBackwards = \false) : LazyCollection
    {
        ...
        $request = GetPaginatedSettlementRefundsQueryFactory::new($settlementId)->withQuery(['from' => $from, 'limit' => $limit, 'filters' => $filters])->create();
