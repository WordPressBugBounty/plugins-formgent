...
use FormGent\Mollie\Api\Http\Requests\GetPaginatedSubscriptionPaymentsRequest;
...
class SubscriptionPaymentEndpointCollection extends EndpointCollection
{
     ...
     * @throws RequestException
     */
    public function pageForIds(string $customerId, string $subscriptionId, ?string $from = null, ?int $limit = null, $testmode = \false) : PaymentCollection
    {
        $testmode = Utility::extractBool($testmode, 'testmode', \false);
        return $this->send((new GetPaginatedSubscriptionPaymentsRequest($customerId, $subscriptionId, $from, $limit))->test($testmode));
    }
    /**
     ...
     * @param  bool|array  $testmode
     */
    public function iteratorFor(Subscription $subscription, ?string $from = null, ?int $limit = null, $testmode = \false, bool $iterateBackwards = \false) : LazyCollection
    {
     ...
     * @param  bool|array  $testmode
     */
    public function iteratorForIds(string $customerId, string $subscriptionId, ?string $from = null, ?int $limit = null, $testmode = \false, bool $iterateBackwards = \false) : LazyCollection
    {
        $testmode = Utility::extractBool($testmode, 'testmode', \false);
        return $this->send((new GetPaginatedSubscriptionPaymentsRequest($customerId, $subscriptionId, $from, $limit))->useIterator()->setIterationDirection($iterateBackwards)->test($testmode));
    }
}
