...
use FormGent\Mollie\Api\Factories\CreateCustomerPaymentRequestFactory;
use FormGent\Mollie\Api\Factories\GetPaginatedCustomerPaymentsRequestFactory;
...
class CustomerPaymentsEndpointCollection extends EndpointCollection
{
    ...
    public function createForId(string $customerId, array $payload = [], array $query = [], bool $testmode = \false) : Payment
    {
        ...
        $request = CreateCustomerPaymentRequestFactory::new($customerId)->withPayload($payload)->withQuery($query)->create();
        /** @var Payment */
    ...
    public function pageForId(string $customerId, ?string $from = null, ?int $limit = null, array $filters = []) : PaymentCollection
    {
        ...
        $request = GetPaginatedCustomerPaymentsRequestFactory::new($customerId)->withQuery(['from' => $from, 'limit' => $limit, 'filters' => $filters])->create();
        return $this->send($request->test($testmode));
    }
    /**
