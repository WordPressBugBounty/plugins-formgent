...
use FormGent\Mollie\Api\Factories\CreatePayoutRequestFactory;
use FormGent\Mollie\Api\Factories\SortablePaginatedQueryFactory;
use FormGent\Mollie\Api\Http\Requests\CancelPayoutRequest;
use FormGent\Mollie\Api\Http\Requests\GetPaginatedPayoutsRequest;
use FormGent\Mollie\Api\Http\Requests\GetPayoutRequest;
...
class PayoutEndpointCollection extends EndpointCollection
{
    ...
    public function create(array $payload = [], bool $testmode = \false) : Payout
    {
        ...
        $request = CreatePayoutRequestFactory::new()->withPayload($payload)->create();
        /** @var Payout */
    ...
    public function page(?string $from = null, ?int $limit = null, array $filters = []) : PayoutCollection
    {
        ...
        $request = new GetPaginatedPayoutsRequest($query->from, $query->limit, $query->sort, $filters['balanceId'] ?? null);
