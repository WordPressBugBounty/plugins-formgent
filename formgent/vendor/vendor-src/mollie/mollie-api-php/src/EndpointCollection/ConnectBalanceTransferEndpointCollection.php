...
use FormGent\Mollie\Api\Factories\CreateConnectBalanceTransferRequestFactory;
use FormGent\Mollie\Api\Http\Requests\GetConnectBalanceTransferRequest;
use FormGent\Mollie\Api\Http\Requests\ListConnectBalanceTransfersRequest;
...
class ConnectBalanceTransferEndpointCollection extends EndpointCollection
{
    ...
    {
        $request = CreateConnectBalanceTransferRequestFactory::new()->withPayload($payload)->create();
     ...
     * @throws RequestException
     */
    public function page(?string $from = null, ?int $limit = null, ?string $sort = null) : ConnectBalanceTransferCollection
    {
        $request = new ListConnectBalanceTransfersRequest($from, $limit, $sort);
     ...
     */
    public function iterator(?string $from = null, ?int $limit = null, ?string $sort = null, bool $iterateBackwards = \false, bool $test = \false) : LazyCollection
    {
        $request = new ListConnectBalanceTransfersRequest($from, $limit, $sort);
