...
use FormGent\Mollie\Api\Factories\GetBalanceReportRequestFactory;
use FormGent\Mollie\Api\Resources\Balance;
use FormGent\Mollie\Api\Resources\BalanceReport;
...
class BalanceReportEndpointCollection extends EndpointCollection
{
    ...
    public function getForId(string $balanceId, array $query = []) : ?BalanceReport
    {
        ...
        $request = GetBalanceReportRequestFactory::new($balanceId)->withQuery($query)->create();
        /** @var BalanceReport */
