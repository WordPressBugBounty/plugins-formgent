...
abstract class DTO {
    ...
    protected bool $bool_to_number = false;

    protected bool $skip_null = false;
    ...
    /**
     * Get the value of bool_to_number
     *
     * @return bool
     */
    public function is_bool_to_number(): bool {
        return $this->bool_to_number;
    }
    
    /**
     * Set the value of bool_to_number
     *
     * @param bool $bool_to_number
     * @return self
     */
    public function set_bool_to_number( bool $bool_to_number ): self {
        $this->bool_to_number = $bool_to_number;
    
        return $this;
    }

    /**
     * Get the value of skip_null
     *
     * @return bool
     */
    public function get_skip_null(): bool {
        return $this->skip_null;
    }
    
    /**
     * Set the value of skip_null
     *
     * @param bool $skip_null
     * @return self
     */
    public function set_skip_null( bool $skip_null ): self {
    ...
    public function to_array() {
        ...
        $exclude_to_array[] = 'bool_to_number';
        $exclude_to_array[] = 'skip_null';
        ...
        foreach ( $reflection->getProperties() as $property ) {
            ...
            if ( $prop->getType() && 'bool' === $prop->getType()->getName() ) {
                ...
                $values[ $property_name ] = $this->bool_to_number ? ( int ) $value : $value;
                continue;
            }

            if ( $this->skip_null && null === $this->{"get_{$property_name}"}() ) {
                continue;
            }
