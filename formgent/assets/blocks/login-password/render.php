...
>
    <div class="formgent-field-single formgent-field-align-<?php echo esc_attr( $attributes['label_alignment'] ); ?>">
        ...
        <div class="formgent-field-single__wrapper formgent-login-password-wrapper">
            <input
                ...
                data-wp-on--input="actions.updateLoginPassword"
            />
            <?php if ( $attributes['enable_password_visibility_toggle'] ) : ?>
            <button
                type="button"
                class="formgent-login-password-toggle"
                tabindex="0"
                aria-label="<?php esc_attr_e( 'Toggle password visibility', 'formgent' ); ?>"
                data-wp-on--click="actions.toggleLoginPasswordVisibility"
                data-wp-on--keydown="actions.handleTogglePasswordKeydown"
            >
                <span
                    class="formgent-login-eye-open"
                    data-wp-class--formgent-display-none="state.loginPasswordVisible"
                >
                    <?php formgent_render_icon( 'eye', 'general' ) ?>
                </span>
                <span
                    class="formgent-login-eye-closed formgent-display-none"
                    data-wp-class--formgent-display-none="!state.loginPasswordVisible"
                >
