...
$url     = ( '' !== $raw_url && false === strpos( $raw_url, '{{' ) ) ? $raw_url : wp_registration_url();
...
>
    <div class="formgent-login-signup formgent-text-align-<?php echo esc_attr( $attributes['text_alignment'] ); ?>">
        <?php if ( ! empty( $attributes['prefix_text'] ) ) : ?>
            <span><?php echo wp_kses_post( $attributes['prefix_text'] ); ?></span>
        <?php endif; ?>

        <a
            href="<?php echo esc_url( $url ); ?>"
            class="formgent-login-signup-link"
            tabindex="0"
        >
        ...
        <?php if ( ! empty( $attributes['suffix_text'] ) ) : ?>
            <span class="formgent-login-signup-suffix"><?php echo wp_kses_post( $attributes['suffix_text'] ); ?></span>
        <?php endif; ?>
    </div>
</div>
