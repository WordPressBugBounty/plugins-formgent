...
`;var R=e(37628);const w=(0,R.MA)(formgent_data?.currencies),C=(0,R.UK)(formgent_data?.currency_symbols);function W({handleUpdatePayment:M,handleUpdateSettings:N}){const{settings:e}=(0,g.useSelect)(M=>{const{getSettings:N}=M(j.A.GLOBAL_SETTINGS);return{settings:N()}},[]),t=[{label:`Left (${C[e?.payment?.currency]}100)`,value:"left"},{label:`Right (100${C[e?.payment?.currency]})`,value:"right"},{label:`Left Space (${C[e?.payment?.currency]} 100)`,value:"left_space"},{label:`Right Space (100 ${C[e?.payment?.currency]})`,value:"right_space"}];return(0,I.jsxs)("div",{className:"formgent-settings-currency",children:[(0,I.jsxs)("div",{className:"formgent-settings-content__field formgent-mb-20",children:[(0,I.jsxs)("span",{className:"formgent-settings-content__field-label",children:[(0,i.__)(" Default currency","formgent")," "]}),(0,I.jsx)(l.AntSelect,{showSearch:!0,value:w.filter(M=>M.value===e?.payment?.currency)[0],onChange:N=>M(N,"currency"),filterOption:(M,N)=>{var e;return(null!==(e=N?.label)&&void 0!==e?e:"").toLowerCase().includes(M.toLowerCase())},placeholder:(0,i.__)("Select default currency","formgent"),options:w,popupClassName:"formgent-select-payment-currency"})]}),(0,I.jsxs)("div",{className:"formgent-settings-content__field",children:[(0,I.jsx)("span",{className:"formgent-settings-content__field-label",children:(0,i.__)("Currency Sign Position","formgent")}),(0,I.jsx)(l.AntRadioGroup,{value:e?.payment?.symbol_position,options:t,onChange:N=>M(N.target.value,"symbol_position")})]}),(0,I.jsx)(l.AntButton,{type:"primary",className:"formgent-save-settings-btn formgent-mt-20",htmlType:"button",onClick:N,children:(0,i.__)("Save Currency","formgent")})]})}var B=e(70742);function f({handleUpdatePayment:M,handleUpdateSettings:N}){const[e]=l.AntForm.useForm(),{settings:t}=(0,g.useSelect)(M=>{const{getSettings:N}=M(j.A.GLOBAL_SETTINGS);return{settings:N()}},[]);(0,a.useEffect)(()=>{t?.payment?.mollie&&e.setFieldsValue(t?.payment?.mollie)},[e,t?.payment?.mollie]);const n=t?.payment?.mollie?.api_key||"",D=n.startsWith("live_")?(0,i.__)("Live mode detected from API key.","formgent"):(0,i.__)("Test mode detected from API key.","formgent");return(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(l.Toggle,{title:(0,i.__)("Enable Mollie","formgent"),description:(0,i.__)("Accept one-time payments through Mollie using a hosted checkout.","formgent"),checked:t?.payment?.mollie?.status||!1,onChange:N=>{M(N,"status","mollie")}}),(0,I.jsxs)("div",{className:"formgent-settings-tab-content-wrap",children:[t?.payment?.mollie?.status&&(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)("h4",{className:"formgent-settings-form-fields__label",children:(0,i.__)("Connect your Mollie account to accept one-time payments","formgent")}),(0,I.jsx)("span",{className:"formgent-settings-form-fields__description",children:(0,i.__)("Mollie uses a single API key. Test and live mode are inferred automatically from the key prefix.","formgent")})]}),(0,I.jsx)("div",{className:"formgent-settings-tab-content-fields",children:(0,I.jsxs)(l.AntForm,{form:e,onFinish:N,children:[t?.payment?.mollie?.status&&(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(B.A,{type:"info",showIcon:!0,message:D,style:{marginBottom:16,marginTop:16}}),(0,I.jsx)(l.AntFormItem,{name:"api_key",rules:[{required:!0,message:(0,i.__)("API Key is required!","formgent")}],children:(0,I.jsx)(l.AntInputPassword,{className:"formgent-form-field",placeholder:(0,i.__)("Mollie API key","formgent"),value:n,onChange:N=>M(N.target.value,"api_key","mollie")})})]}),(0,I.jsx)(l.AntButton,{type:"primary",className:"formgent-save-settings-btn",htmlType:"submit",children:(0,i.__)("Save changes","formgent")})]})})]})]})}function b({handleUpdateSettings:M,handleUpdatePayment:N}){const{settings:e,loading:t}=(0,g.useSelect)(M=>{const{getSettings:N,isLoading:e}=M(j.A.GLOBAL_SETTINGS);return{settings:N(),loading:e()}},[]);return(0,a.useEffect)(()=>{(0,g.resolveSelect)("formgent").fetchPages()},[]),(0,I.jsxs)("div",{className:"formgent-settings-page-configuration",style:{width:"100%"},children:[(0,I.jsxs)("div",{className:"formgent-settings-content__field formgent-mb-20",children:[(0,I.jsxs)("span",{className:"formgent-settings-content__field-label",children:[(0,i.__)("Payment success page","formgent")," "]}),(0,I.jsx)(l.WPPages,{handleInputChange:(M,e)=>{N(e,"success_page")},pageSelected:e?.payment?.success_page}),(0,I.jsxs)("span",{className:"formgent-settings-content__field-note",children:[(0,i.__)("Use the following shortcode to display the payment success message","formgent"),": ",(0,I.jsx)("code",{children:"[formgent_payment_success]"})]})]}),(0,I.jsxs)("div",{className:"formgent-settings-content__field formgent-mb-20",children:[(0,I.jsxs)("span",{className:"formgent-settings-content__field-label",children:[(0,i.__)("Payment Failed page","formgent")," "]}),(0,I.jsx)(l.WPPages,{handleInputChange:(M,e)=>{N(e,"failed_page")},pageSelected:e?.payment?.failed_page}),(0,I.jsxs)("span",{className:"formgent-settings-content__field-note",children:[(0,i.__)("Use the following shortcode to display the payment failed message","formgent"),": ",(0,I.jsx)("code",{children:"[formgent_payment_failed]"})]})]}),(0,I.jsx)(l.AntButton,{type:"primary",className:"formgent-save-settings-btn",htmlType:"button",onClick:M,children:(0,i.__)("Save Page Configuration","formgent")})]})}function J({handleUpdatePayment:M,handleUpdateSettings:N}){const[e]=l.AntForm.useForm(),{settings:t}=(0,g.useSelect)(M=>{const{getSettings:N}=M(j.A.GLOBAL_SETTINGS);return{settings:N()}},[]);return(0,a.useEffect)(()=>{t?.payment?.paypal&&e.setFieldsValue(t?.payment?.paypal)},[t?.payment?.paypal]),(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(l.Toggle,{title:(0,i.__)("Enable PayPal","formgent"),description:(0,i.__)("Easily collect PayPal Checkout and credit card payments with PayPal .","formgent"),checked:t?.payment?.paypal?.status||!1,onChange:N=>{M(N,"status","paypal")}}),t?.payment?.paypal?.status&&(0,I.jsx)(l.Toggle,{title:(0,i.__)("Enable Test Mode","formgent"),description:(0,i.__)("Prevent PayPal Commerce from processing live transactions. Please, see <a href='https://developer.paypal.com/tools/sandbox/'>PayPal Commerce documentation</a> for full details.","formgent"),checked:t?.payment?.paypal?.test_mode||!1,onChange:N=>{M(N,"test_mode","paypal")}}),(0,I.jsxs)("div",{className:"formgent-settings-tab-content-wrap",children:[t?.payment?.paypal?.status&&(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)("h4",{className:"formgent-settings-form-fields__label",children:(0,i.__)("Connect your PayPal Account to your website to accept Payments","formgent")}),(0,I.jsx)("span",{className:"formgent-settings-form-fields__description",children:(0,i.__)("Securely connect to PayPal with just a few clicks to begin accepting payments!","formgent")})]}),(0,I.jsx)("div",{className:"formgent-settings-tab-content-fields",children:(0,I.jsxs)(l.AntForm,{form:e,onFinish:N,children:[t?.payment?.paypal?.status&&(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(l.AntFormItem,{name:"client_id",rules:[{required:!0,message:(0,i.__)("Client Id is required!","formgent")}],children:(0,I.jsx)(l.AntInput,{className:"formgent-form-field",value:t?.payment?.paypal?.client_id||"",placeholder:(0,i.__)("Client id","formgent"),onChange:N=>M(N.target.value,"client_id","paypal")})}),(0,I.jsx)(l.AntFormItem,{name:"secret_key",rules:[{required:!0,message:(0,i.__)("Secret Key is required!","formgent")}],children:(0,I.jsx)(l.AntInputPassword,{className:"formgent-form-field",placeholder:(0,i.__)("Secret key","formgent"),value:t?.payment?.paypal?.secret_key||"",onChange:N=>M(N.target.value,"secret_key","paypal")})})]}),(0,I.jsx)(l.AntButton,{type:"primary",className:"formgent-save-settings-btn",htmlType:"submit",children:(0,i.__)("Save changes","formgent")})]})})]})]})}var G=e(13526);function v({handleUpdatePayment:M,handleUpdateSettings:N}){const[e]=l.AntForm.useForm(),{settings:t}=(0,g.useSelect)(M=>{const{getSettings:N}=M(j.A.GLOBAL_SETTINGS);return{settings:N()}},[]);return(0,a.useEffect)(()=>{t?.payment?.stripe&&e.setFieldsValue(t?.payment?.stripe)},[t?.payment?.stripe]),(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(l.Toggle,{title:(0,i.__)("Enable Stripe","formgent"),description:(0,i.__)("Easily collect Stripe Checkout and credit card payments with Stripe.","formgent"),checked:t?.payment?.stripe?.status||!1,onChange:N=>{M(N,"status","stripe")}}),t?.payment?.stripe?.status&&(0,I.jsx)(l.Toggle,{title:(0,i.__)("Enable Test Mode","formgent"),description:(0,i.__)("Prevent Stripe from processing live transactions.","formgent"),checked:t?.payment?.stripe?.test_mode||!1,onChange:N=>{M(N,"test_mode","stripe")}}),(0,I.jsxs)("div",{className:"formgent-settings-tab-content-wrap",children:[t?.payment?.stripe?.status&&(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)("h4",{className:"formgent-settings-form-fields__label",children:(0,i.__)("Connect your Stripe Account to your website to accept Payments","formgent")}),(0,I.jsx)("span",{className:"formgent-settings-form-fields__description",children:(0,i.__)("Securely connect to Stripe with just a few clicks to begin accepting payments!","formgent")})]}),(0,I.jsx)("div",{className:"formgent-settings-tab-content-fields",children:(0,I.jsxs)(l.AntForm,{form:e,onFinish:N,children:[t?.payment?.stripe?.status&&(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(l.AntFormItem,{name:"publishable_key",rules:[{required:!0,message:(0,i.__)("Publishable Key is required!","formgent")}],children:(0,I.jsx)(l.AntInput,{className:"formgent-form-field",value:t?.payment?.stripe?.publishable_key||"",placeholder:(0,i.__)("Publishable key","formgent"),onChange:N=>M(N.target.value,"publishable_key","stripe")})}),(0,I.jsx)(l.AntFormItem,{name:"secret_key",rules:[{required:!0,message:(0,i.__)("Secret Key is required!","formgent")}],children:(0,I.jsx)(l.AntInputPassword,{className:"formgent-form-field",placeholder:(0,i.__)("Secret key","formgent"),value:t?.payment?.stripe?.secret_key||"",onChange:N=>M(N.target.value,"secret_key","stripe")})})]}),(0,I.jsx)(l.AntButton,{type:"primary",className:"formgent-save-settings-btn",htmlType:"submit",children:(0,i.__)("Save changes","formgent")})]})})]})]})}function _(){const[M,N]=(0,a.useState)("paypal"),{settings:e}=(0,g.useSelect)(M=>{const{getSettings:N}=M(j.A.GLOBAL_SETTINGS);return{settings:N()}},[]),{updatePaymentSettings:t,updateSettings:D}=(0,g.useDispatch)(j.A.GLOBAL_SETTINGS),T=[{key:"paypal",label:(0,i.__)("Paypal","formgent"),icon:"data:image/svg+xml;base64,",component:J},{key:"stripe",label:(0,i.__)("Stripe","formgent"),icon:F.A,component:v},{key:"mollie",label:(0,i.__)("Mollie","formgent"),icon:"data:image/svg+xml;base64,",component:f}];function c(M,N,g){let n;n=g?{...e?.payment,[g]:{...e?.payment?.[g],[N]:M}}:{...e?.payment,[N]:M},t(n)}async function l(){try{await D({payment:{...e?.payment}}),(0,n.doAction)("formgent-toast",{message:(0,i.__)("Payment Settings Updated Successfully","formgent"),type:"success"})}catch(M){console.error(M)}}return(0,I.jsxs)("div",{className:"formgent-settings-content",children:[(0,I.jsxs)("div",{className:"formgent-settings-content__head",children:[(0,I.jsx)("h2",{className:"formgent-settings-content__title",children:(0,i.__)("Payment Settings","formgent")}),(0,I.jsx)("p",{className:"formgent-settings-content__description",children:(0,i.__)("Payment setting will be applied to all payment blocks in the form.","formgent")})]}),(0,I.jsxs)("div",{className:"formgent-settings-content__payment",children:[(0,I.jsx)("span",{className:"formgent-settings-content__payment-title",children:(0,i.__)("Page configuration","formgent")}),(0,I.jsx)("div",{className:"formgent-card-action",children:(0,I.jsx)(b,{handleUpdatePayment:c,handleUpdateSettings:l})})]}),(0,I.jsxs)("div",{className:"formgent-settings-content__payment",children:[(0,I.jsx)("span",{className:"formgent-settings-content__payment-title",children:(0,i.__)("Currency","formgent")}),(0,I.jsx)("div",{className:"formgent-card-action",children:(0,I.jsx)(W,{handleUpdatePayment:c,handleUpdateSettings:l})})]}),(0,I.jsxs)("div",{className:"formgent-settings-content__payment",children:[(0,I.jsx)("span",{className:"formgent-settings-content__payment-title",children:(0,i.sprintf)(/* translators: %d: number of payment gateways */ /* translators: %d: number of payment gateways */
(0,i.__)("Available Payment Gateways (%d)","formgent"),T.length)}),(0,I.jsx)("div",{className:"formgent-card-action",children:(0,I.jsxs)(Z,{children:[(0,I.jsx)("div",{className:"formgent-settings-tab-nav",children:T.map(e=>(0,I.jsxs)("span",{className:(0,G.A)("formgent-settings-tab-nav__item",{"formgent-active":M===e.key}),onClick:()=>N(e.key),children:[(0,I.jsx)(U.A,{src:e.icon}),e.label]},e.key))}),(0,I.jsx)("div",{className:"formgent-settings-tab-content",children:T.map(N=>{if(M!==N.key)return null;const e=N.component;return(0,I.jsx)(e,{handleUpdatePayment:c,handleUpdateSettings:l},N.key)})})]})})]})]})}var X=e(2736),H=e.n(X);function P(M){const{Fill:N,Slot:e}=(0,t.createSlotFill)(M),g=({render:M})=>(0,I.jsx)(N,{children:N=>(0,I.jsx)(M,{...N})});return g.Slot=e,g.propTypes={render:H().elementType.isRequired},g}const K=P("LicenseSettings"),q=P("SMSSettings");var $=e(77817),MM=e(98090);function NM({title:M,description:N,backgroundImage:e,buttonValue:t,subtitle:g,classNames:n=""}){return(0,I.jsxs)(o.hL,{className:`formgent-pro-feature-cta ${n}`,children:[e&&(0,I.jsx)("img",{src:e,alt:"Premium Feature"}),(0,I.jsxs)("div",{className:"formgent-pro-feature-cta__content",children:[(0,I.jsx)("div",{className:"formgent-pro-feature-cta__icon",children:(0,I.jsx)(MM.A,{})}),(0,I.jsx)("h2",{className:"formgent-pro-feature-cta__title",children:M}),g&&(0,I.jsx)("span",{className:"formgent-pro-feature-cta__subtitle",children:g}),(0,I.jsx)("p",{className:"formgent-pro-feature-cta__description",children:N}),(0,I.jsxs)("a",{href:"https://formgent.com/pricing",className:"formgent-pro-feature-cta__btn",target:"_blank",children:[(0,I.jsx)($.A,{}),t]})]})]})}function eM(){const{disable_ip_logging:M,loading:N}=(0,g.useSelect)(M=>{const{getIPLogging:N,isLoading:e}=M(j.A.GLOBAL_SETTINGS);return{disable_ip_logging:N(),loading:e()}},[]),{updateDisableIPLogging:e,updateSettings:t}=(0,g.useDispatch)(j.A.GLOBAL_SETTINGS);return(0,I.jsxs)("div",{className:"formgent-settings-content",children:[(0,I.jsx)("div",{className:"formgent-settings-content__head",children:(0,I.jsx)("h4",{className:"formgent-settings-content__title",children:(0,i.__)("General Settings","formgent")})}),N?(0,I.jsx)(l.AntSkeleton,{active:!0}):(0,I.jsx)("div",{className:"formgent-settings-content__item",children:(0,I.jsx)("div",{className:"formgent-settings-content__toggle",children:(0,I.jsx)(l.Toggle,{title:(0,i.__)("Disable IP Logging","formgent"),description:(0,i.__)("When enabled, the user's IP address will not be saved with the form submission.","formgent"),checked:"yes"===M||!0===M,onChange:async function(M){e(M?"yes":"no");try{await t({disable_ip_logging:M?"yes":"no"}),(0,n.doAction)("formgent-toast",{message:M?(0,i.__)("IP Logging Disabled","formgent"):(0,i.__)("IP Logging Enabled","formgent"),type:"success"})}catch(M){console.error(M)}}})})})]})}const tM={login:{status:"0",page:""},registration:{status:"0",page:""}},gM=M=>{var N;return M&&"object"==typeof M?{status:!0===M.status||"1"===M.status?"1":"0",page:null!==(N=M.page)&&void 0!==N?N:""}:{status:"0",page:""}};function nM(){const{settings:M,loading:N}=(0,g.useSelect)(M=>{const{getSettings:N,isLoading:e}=M(j.A.GLOBAL_SETTINGS);return{settings:N(),loading:e()}},[]),{updateSettings:e}=(0,g.useDispatch)(j.A.GLOBAL_SETTINGS),t=(0,a.useMemo)(()=>{var N;const e=null!==(N=M?.login_registration)&&void 0!==N?N:tM;return{login:gM(e.login),registration:gM(e.registration)}},[M?.login_registration]),[D,T]=(0,a.useState)(t);(0,a.useEffect)(()=>{T(t)},[t]),(0,a.useEffect)(()=>{(0,g.resolveSelect)("formgent").fetchPages?.()},[]);const c=async M=>{const N={...D,...M};T(N);try{await e({login_registration:N}),(0,n.doAction)("formgent-toast",{message:(0,i.__)("Settings have been updated successfully.","formgent"),type:"success"})}catch(M){console.error(M)}};return(0,I.jsxs)("div",{className:"formgent-settings-content",children:[(0,I.jsx)("div",{className:"formgent-settings-content__head",children:(0,I.jsx)("h4",{className:"formgent-settings-content__title",children:(0,i.__)("Login/Registration","formgent")})}),N?(0,I.jsx)(l.AntSkeleton,{active:!0}):(0,I.jsxs)("div",{className:"formgent-settings-content__item",children:[(0,I.jsxs)("div",{className:"formgent-settings-content__toggle formgent-mb-20",children:[(0,I.jsx)(l.Toggle,{title:(0,i.__)("Enable Custom Login Page","formgent"),description:(0,i.__)("Enable this to assign your Custom Login page and offer a personalized log-in experience.","formgent"),checked:"1"===D.login.status,onChange:M=>{c({login:{...D.login,status:M?"1":"0"}})}}),"1"===D.login.status&&(0,I.jsx)("div",{className:"formgent-page-selection-wrapper formgent-mt-15 formgent-mb-30",children:(0,I.jsx)("div",{className:"formgent-settings-page-configuration",children:(0,I.jsxs)("div",{className:"formgent-settings-content__field",children:[(0,I.jsx)("span",{className:"formgent-settings-content__field-label",children:(0,i.__)("Login page","formgent")}),(0,I.jsx)(l.WPPages,{handleInputChange:(M,N)=>{c({login:{...D.login,page:null!=N?N:""}})},pageSelected:D.login.page})]})})})]}),(0,I.jsxs)("div",{className:"formgent-settings-content__toggle formgent-mb-20",children:[(0,I.jsx)(l.Toggle,{title:(0,i.__)("Enable Custom Registration Page","formgent"),description:(0,i.__)("Enable this to assign your Custom Registration page and offer a personalized sign-up experience.","formgent"),checked:"1"===D.registration.status,onChange:M=>{c({registration:{...D.registration,status:M?"1":"0"}})}}),"1"===D.registration.status&&(0,I.jsx)("div",{className:"formgent-page-selection-wrapper formgent-mt-15",children:(0,I.jsx)("div",{className:"formgent-settings-page-configuration",children:(0,I.jsxs)("div",{className:"formgent-settings-content__field",children:[(0,I.jsx)("span",{className:"formgent-settings-content__field-label",children:(0,i.__)("Registration page","formgent")}),(0,I.jsx)(l.WPPages,{handleInputChange:(M,N)=>{c({registration:{...D.registration,page:null!=N?N:""}})},pageSelected:D.registration.page})]})})})]})]})]})}const iM=x.Ay.div`
	border-radius: 10px;
	border: 1px solid var( --formgent-color-gray-200 );
	background: #fff;
	box-shadow: 0px 1px 2px 0px rgba( 16, 24, 40, 0.05 );
