...
`;const F=z.Ay.div`
    ...
    .formgent-settings-content__item{
        ...
        .formgent-page-selection-wrapper{
            max-width: 780px;
        }
    }
    ...
    .formgent-settings-content__page-selection{
        .formgent-card-action{
            max-width: 830px;
        }
        .formgent-settings-page-configuration{
            width: 100%;
        }
    }
    ...
    @media (max-width: 782px) {
        ...
        .formgent-settings-sider__nav .ant-menu-item {
            flex: 0 0 auto;
...
`,Z=z.Ay.div`
    .formgent-settings-sms-gateway-cta{
        &:before{
            content: none;
        }
    }
`;var f=t(37628);const Y=(0,f.MA)(formgent_data?.currencies),R=(0,f.UK)(formgent_data?.currency_symbols);function C({handleUpdatePayment:e,handleUpdateSettings:M}){const{settings:t}=(0,N.useSelect)(e=>{const{getSettings:M}=e(a.A.GLOBAL_SETTINGS);return{settings:M()}},[]),n=[{label:`Left (${R[t?.payment?.currency]}100)`,value:"left"},{label:`Right (100${R[t?.payment?.currency]})`,value:"right"},{label:`Left Space (${R[t?.payment?.currency]} 100)`,value:"left_space"},{label:`Right Space (100 ${R[t?.payment?.currency]})`,value:"right_space"}];return(0,s.jsxs)("div",{className:"formgent-settings-currency",children:[(0,s.jsxs)("div",{className:"formgent-settings-content__field formgent-mb-20",children:[(0,s.jsxs)("span",{className:"formgent-settings-content__field-label",children:[(0,g.__)(" Default currency","formgent")," "]}),(0,s.jsx)(D.AntSelect,{showSearch:!0,value:Y.filter(e=>e.value===t?.payment?.currency)[0],onChange:M=>e(M,"currency"),filterOption:(e,M)=>{var t;return(null!==(t=M?.label)&&void 0!==t?t:"").toLowerCase().includes(e.toLowerCase())},placeholder:(0,g.__)("Select default currency","formgent"),options:Y,popupClassName:"formgent-select-payment-currency"})]}),(0,s.jsxs)("div",{className:"formgent-settings-content__field",children:[(0,s.jsx)("span",{className:"formgent-settings-content__field-label",children:(0,g.__)("Currency Sign Position","formgent")}),(0,s.jsx)(D.AntRadioGroup,{value:t?.payment?.symbol_position,options:n,onChange:M=>e(M.target.value,"symbol_position")})]}),(0,s.jsx)(D.AntButton,{type:"primary",className:"formgent-save-settings-btn formgent-mt-20",htmlType:"button",onClick:M,children:(0,g.__)("Save Currency","formgent")})]})}var W=t(70742);function b({handleUpdatePayment:e,handleUpdateSettings:M}){const[t]=D.AntForm.useForm(),{settings:n}=(0,N.useSelect)(e=>{const{getSettings:M}=e(a.A.GLOBAL_SETTINGS);return{settings:M()}},[]);(0,l.useEffect)(()=>{n?.payment?.mollie&&t.setFieldsValue(n?.payment?.mollie)},[t,n?.payment?.mollie]);const i=n?.payment?.mollie?.api_key||"",o=i.startsWith("live_")?(0,g.__)("Live mode detected from API key.","formgent"):(0,g.__)("Test mode detected from API key.","formgent");return(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(D.Toggle,{title:(0,g.__)("Enable Mollie","formgent"),description:(0,g.__)("Accept one-time payments through Mollie using a hosted checkout.","formgent"),checked:n?.payment?.mollie?.status||!1,onChange:M=>{e(M,"status","mollie")}}),(0,s.jsxs)("div",{className:"formgent-settings-tab-content-wrap",children:[n?.payment?.mollie?.status&&(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)("h4",{className:"formgent-settings-form-fields__label",children:(0,g.__)("Connect your Mollie account to accept one-time payments","formgent")}),(0,s.jsx)("span",{className:"formgent-settings-form-fields__description",children:(0,g.__)("Mollie uses a single API key. Test and live mode are inferred automatically from the key prefix.","formgent")})]}),(0,s.jsx)("div",{className:"formgent-settings-tab-content-fields",children:(0,s.jsxs)(D.AntForm,{form:t,onFinish:M,children:[n?.payment?.mollie?.status&&(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(W.A,{type:"info",showIcon:!0,message:o,style:{marginBottom:16,marginTop:16}}),(0,s.jsx)(D.AntFormItem,{name:"api_key",rules:[{required:!0,message:(0,g.__)("API Key is required!","formgent")}],children:(0,s.jsx)(D.AntInputPassword,{className:"formgent-form-field",placeholder:(0,g.__)("Mollie API key","formgent"),value:i,onChange:M=>e(M.target.value,"api_key","mollie")})})]}),(0,s.jsx)(D.AntButton,{type:"primary",className:"formgent-save-settings-btn",htmlType:"submit",children:(0,g.__)("Save changes","formgent")})]})})]})]})}function B({handleUpdateSettings:e,handleUpdatePayment:M}){const{settings:t,loading:n}=(0,N.useSelect)(e=>{const{getSettings:M,isLoading:t}=e(a.A.GLOBAL_SETTINGS);return{settings:M(),loading:t()}},[]);return(0,l.useEffect)(()=>{(0,N.resolveSelect)("formgent").fetchPages()},[]),(0,s.jsxs)("div",{className:"formgent-settings-page-configuration",style:{width:"100%"},children:[(0,s.jsxs)("div",{className:"formgent-settings-content__field formgent-mb-20",children:[(0,s.jsxs)("span",{className:"formgent-settings-content__field-label",children:[(0,g.__)("Payment success page","formgent")," "]}),(0,s.jsx)(D.WPPages,{handleInputChange:(e,t)=>{M(t,"success_page")},pageSelected:t?.payment?.success_page}),(0,s.jsxs)("span",{className:"formgent-settings-content__field-note",children:[(0,g.__)("Use the following shortcode to display the payment success message","formgent"),": ",(0,s.jsx)("code",{children:"[formgent_payment_success]"})]})]}),(0,s.jsxs)("div",{className:"formgent-settings-content__field formgent-mb-20",children:[(0,s.jsxs)("span",{className:"formgent-settings-content__field-label",children:[(0,g.__)("Payment Failed page","formgent")," "]}),(0,s.jsx)(D.WPPages,{handleInputChange:(e,t)=>{M(t,"failed_page")},pageSelected:t?.payment?.failed_page}),(0,s.jsxs)("span",{className:"formgent-settings-content__field-note",children:[(0,g.__)("Use the following shortcode to display the payment failed message","formgent"),": ",(0,s.jsx)("code",{children:"[formgent_payment_failed]"})]})]}),(0,s.jsx)(D.AntButton,{type:"primary",className:"formgent-save-settings-btn",htmlType:"button",onClick:e,children:(0,g.__)("Save Page Configuration","formgent")})]})}function J({handleUpdatePayment:e,handleUpdateSettings:M}){const[t]=D.AntForm.useForm(),{settings:n}=(0,N.useSelect)(e=>{const{getSettings:M}=e(a.A.GLOBAL_SETTINGS);return{settings:M()}},[]);return(0,l.useEffect)(()=>{n?.payment?.paypal&&t.setFieldsValue(n?.payment?.paypal)},[n?.payment?.paypal]),(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(D.Toggle,{title:(0,g.__)("Enable PayPal","formgent"),description:(0,g.__)("Easily collect PayPal Checkout and credit card payments with PayPal .","formgent"),checked:n?.payment?.paypal?.status||!1,onChange:M=>{e(M,"status","paypal")}}),n?.payment?.paypal?.status&&(0,s.jsx)(D.Toggle,{title:(0,g.__)("Enable Test Mode","formgent"),description:(0,g.__)("Prevent PayPal Commerce from processing live transactions. Please, see <a href='https://developer.paypal.com/tools/sandbox/'>PayPal Commerce documentation</a> for full details.","formgent"),checked:n?.payment?.paypal?.test_mode||!1,onChange:M=>{e(M,"test_mode","paypal")}}),(0,s.jsxs)("div",{className:"formgent-settings-tab-content-wrap",children:[n?.payment?.paypal?.status&&(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)("h4",{className:"formgent-settings-form-fields__label",children:(0,g.__)("Connect your PayPal Account to your website to accept Payments","formgent")}),(0,s.jsx)("span",{className:"formgent-settings-form-fields__description",children:(0,g.__)("Securely connect to PayPal with just a few clicks to begin accepting payments!","formgent")})]}),(0,s.jsx)("div",{className:"formgent-settings-tab-content-fields",children:(0,s.jsxs)(D.AntForm,{form:t,onFinish:M,children:[n?.payment?.paypal?.status&&(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(D.AntFormItem,{name:"client_id",rules:[{required:!0,message:(0,g.__)("Client Id is required!","formgent")}],children:(0,s.jsx)(D.AntInput,{className:"formgent-form-field",value:n?.payment?.paypal?.client_id||"",placeholder:(0,g.__)("Client id","formgent"),onChange:M=>e(M.target.value,"client_id","paypal")})}),(0,s.jsx)(D.AntFormItem,{name:"secret_key",rules:[{required:!0,message:(0,g.__)("Secret Key is required!","formgent")}],children:(0,s.jsx)(D.AntInputPassword,{className:"formgent-form-field",placeholder:(0,g.__)("Secret key","formgent"),value:n?.payment?.paypal?.secret_key||"",onChange:M=>e(M.target.value,"secret_key","paypal")})})]}),(0,s.jsx)(D.AntButton,{type:"primary",className:"formgent-save-settings-btn",htmlType:"submit",children:(0,g.__)("Save changes","formgent")})]})})]})]})}var v=t(13526);function G({handleUpdatePayment:e,handleUpdateSettings:M}){const[t]=D.AntForm.useForm(),{settings:n}=(0,N.useSelect)(e=>{const{getSettings:M}=e(a.A.GLOBAL_SETTINGS);return{settings:M()}},[]);return(0,l.useEffect)(()=>{n?.payment?.stripe&&t.setFieldsValue(n?.payment?.stripe)},[n?.payment?.stripe]),(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(D.Toggle,{title:(0,g.__)("Enable Stripe","formgent"),description:(0,g.__)("Easily collect Stripe Checkout and credit card payments with Stripe.","formgent"),checked:n?.payment?.stripe?.status||!1,onChange:M=>{e(M,"status","stripe")}}),n?.payment?.stripe?.status&&(0,s.jsx)(D.Toggle,{title:(0,g.__)("Enable Test Mode","formgent"),description:(0,g.__)("Prevent Stripe from processing live transactions.","formgent"),checked:n?.payment?.stripe?.test_mode||!1,onChange:M=>{e(M,"test_mode","stripe")}}),(0,s.jsxs)("div",{className:"formgent-settings-tab-content-wrap",children:[n?.payment?.stripe?.status&&(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)("h4",{className:"formgent-settings-form-fields__label",children:(0,g.__)("Connect your Stripe Account to your website to accept Payments","formgent")}),(0,s.jsx)("span",{className:"formgent-settings-form-fields__description",children:(0,g.__)("Securely connect to Stripe with just a few clicks to begin accepting payments!","formgent")})]}),(0,s.jsx)("div",{className:"formgent-settings-tab-content-fields",children:(0,s.jsxs)(D.AntForm,{form:t,onFinish:M,children:[n?.payment?.stripe?.status&&(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(D.AntFormItem,{name:"publishable_key",rules:[{required:!0,message:(0,g.__)("Publishable Key is required!","formgent")}],children:(0,s.jsx)(D.AntInput,{className:"formgent-form-field",value:n?.payment?.stripe?.publishable_key||"",placeholder:(0,g.__)("Publishable key","formgent"),onChange:M=>e(M.target.value,"publishable_key","stripe")})}),(0,s.jsx)(D.AntFormItem,{name:"secret_key",rules:[{required:!0,message:(0,g.__)("Secret Key is required!","formgent")}],children:(0,s.jsx)(D.AntInputPassword,{className:"formgent-form-field",placeholder:(0,g.__)("Secret key","formgent"),value:n?.payment?.stripe?.secret_key||"",onChange:M=>e(M.target.value,"secret_key","stripe")})})]}),(0,s.jsx)(D.AntButton,{type:"primary",className:"formgent-save-settings-btn",htmlType:"submit",children:(0,g.__)("Save changes","formgent")})]})})]})]})}function _(){const[e,M]=(0,l.useState)("paypal"),{settings:t}=(0,N.useSelect)(e=>{const{getSettings:M}=e(a.A.GLOBAL_SETTINGS);return{settings:M()}},[]),{updatePaymentSettings:n,updateSettings:o}=(0,N.useDispatch)(a.A.GLOBAL_SETTINGS),c=[{key:"paypal",label:(0,g.__)("Paypal","formgent"),icon:"data:image/svg+xml;base64,",component:J},{key:"stripe",label:(0,g.__)("Stripe","formgent"),icon:V.A,component:G},{key:"mollie",label:(0,g.__)("Mollie","formgent"),icon:"data:image/svg+xml;base64,",component:b}];function r(e,M,N){let i;i=N?{...t?.payment,[N]:{...t?.payment?.[N],[M]:e}}:{...t?.payment,[M]:e},n(i)}async function D(){try{await o({payment:{...t?.payment}}),(0,i.doAction)("formgent-toast",{message:(0,g.__)("Payment Settings Updated Successfully","formgent"),type:"success"})}catch(e){console.error(e)}}return(0,s.jsxs)("div",{className:"formgent-settings-content",children:[(0,s.jsxs)("div",{className:"formgent-settings-content__head",children:[(0,s.jsx)("h2",{className:"formgent-settings-content__title",children:(0,g.__)("Payment Settings","formgent")}),(0,s.jsx)("p",{className:"formgent-settings-content__description",children:(0,g.__)("Payment setting will be applied to all payment blocks in the form.","formgent")})]}),(0,s.jsxs)("div",{className:"formgent-settings-content__payment",children:[(0,s.jsx)("span",{className:"formgent-settings-content__payment-title",children:(0,g.__)("Page configuration","formgent")}),(0,s.jsx)("div",{className:"formgent-card-action",children:(0,s.jsx)(B,{handleUpdatePayment:r,handleUpdateSettings:D})})]}),(0,s.jsxs)("div",{className:"formgent-settings-content__payment",children:[(0,s.jsx)("span",{className:"formgent-settings-content__payment-title",children:(0,g.__)("Currency","formgent")}),(0,s.jsx)("div",{className:"formgent-card-action",children:(0,s.jsx)(C,{handleUpdatePayment:r,handleUpdateSettings:D})})]}),(0,s.jsxs)("div",{className:"formgent-settings-content__payment",children:[(0,s.jsx)("span",{className:"formgent-settings-content__payment-title",children:(0,g.sprintf)(/* translators: %d: number of payment gateways */ /* translators: %d: number of payment gateways */
(0,g.__)("Available Payment Gateways (%d)","formgent"),c.length)}),(0,s.jsx)("div",{className:"formgent-card-action",children:(0,s.jsxs)(w,{children:[(0,s.jsx)("div",{className:"formgent-settings-tab-nav",children:c.map(t=>(0,s.jsxs)("span",{className:(0,v.A)("formgent-settings-tab-nav__item",{"formgent-active":e===t.key}),onClick:()=>M(t.key),children:[(0,s.jsx)(x.A,{src:t.icon}),t.label]},t.key))}),(0,s.jsx)("div",{className:"formgent-settings-tab-content",children:c.map(M=>{if(e!==M.key)return null;const t=M.component;return(0,s.jsx)(t,{handleUpdatePayment:r,handleUpdateSettings:D},M.key)})})]})})]})]})}var H=t(2736),X=t.n(H);function P(e){const{Fill:M,Slot:t}=(0,n.createSlotFill)(e),N=({render:e})=>(0,s.jsx)(M,{children:M=>(0,s.jsx)(e,{...M})});return N.Slot=t,N.propTypes={render:X().elementType.isRequired},N}const K=P("LicenseSettings"),q=P("SMSSettings");var $=t(77817),ee=t(98090);function Me({title:e,description:M,backgroundImage:t,buttonValue:n,subtitle:N,classNames:i=""}){return(0,s.jsxs)(j.hL,{className:`formgent-pro-feature-cta ${i}`,children:[t&&(0,s.jsx)("img",{src:t,alt:"Premium Feature"}),(0,s.jsxs)("div",{className:"formgent-pro-feature-cta__content",children:[(0,s.jsx)("div",{className:"formgent-pro-feature-cta__icon",children:(0,s.jsx)(ee.A,{})}),(0,s.jsx)("h2",{className:"formgent-pro-feature-cta__title",children:e}),N&&(0,s.jsx)("span",{className:"formgent-pro-feature-cta__subtitle",children:N}),(0,s.jsx)("p",{className:"formgent-pro-feature-cta__description",children:M}),(0,s.jsxs)("a",{href:"https://formgent.com/pricing",className:"formgent-pro-feature-cta__btn",target:"_blank",children:[(0,s.jsx)($.A,{}),n]})]})]})}function te(){const{disableIpLogging:e,formPermalinkBase:M,loading:t}=(0,N.useSelect)(e=>{const{getIPLogging:M,getSettings:t,isLoading:n}=e(a.A.GLOBAL_SETTINGS);return{disableIpLogging:M(),formPermalinkBase:t()?.form_permalink_base||"form",loading:n()}},[]),{updateDisableIPLogging:n,updateSettings:o}=(0,N.useDispatch)(a.A.GLOBAL_SETTINGS);return(0,s.jsxs)("div",{className:"formgent-settings-content",children:[(0,s.jsx)("div",{className:"formgent-settings-content__head",children:(0,s.jsx)("h4",{className:"formgent-settings-content__title",children:(0,g.__)("General Settings","formgent")})}),t?(0,s.jsx)(D.AntSkeleton,{active:!0}):(0,s.jsxs)("div",{className:"formgent-settings-content__item",children:[(0,s.jsx)("div",{className:"formgent-settings-content__toggle",children:(0,s.jsx)(D.Toggle,{title:(0,g.__)("Disable IP Logging","formgent"),description:(0,g.__)("When enabled, the user's IP address will not be saved with the form submission.","formgent"),checked:"yes"===e||!0===e,onChange:async function(e){n(e?"yes":"no");try{await o({disable_ip_logging:e?"yes":"no"}),(0,i.doAction)("formgent-toast",{message:e?(0,g.__)("IP Logging Disabled","formgent"):(0,g.__)("IP Logging Enabled","formgent"),type:"success"})}catch(e){console.error(e)}}})}),(0,s.jsx)(D.PermalinkBaseControl,{value:M,defaultValue:"form",homeUrl:window.formgent_data?.home_url||"",exampleResource:"contact-form",title:(0,g.__)("Form URL Base","formgent"),description:(0,g.__)("Choose the first URL segment used by FormGent form pages. Change it when another plugin already uses the same route.","formgent"),warning:(0,g.__)("Existing form links will change. Update copied or shared links and clear your site cache after saving.","formgent"),placeholder:(0,g.__)("form","formgent"),saveLabel:(0,g.__)("Save URL Base","formgent"),savingLabel:(0,g.__)("Saving…","formgent"),onSave:async function(e){try{const M=await o({form_permalink_base:e}),t=M?.form_permalink_base||e;return(0,i.doAction)("formgent-toast",{message:(0,g.__)("Form URL base updated successfully.","formgent"),type:"success"}),t}catch(e){throw(0,i.doAction)("formgent-toast",{message:e?.message||(0,g.__)("The form URL base could not be updated.","formgent"),type:"error"}),e}}})]})]})}const ne={login:{status:"0",page:""},registration:{status:"0",page:""}},Ne=e=>{var M;return e&&"object"==typeof e?{status:!0===e.status||"1"===e.status?"1":"0",page:null!==(M=e.page)&&void 0!==M?M:""}:{status:"0",page:""}};function ie(){const{settings:e,loading:M}=(0,N.useSelect)(e=>{const{getSettings:M,isLoading:t}=e(a.A.GLOBAL_SETTINGS);return{settings:M(),loading:t()}},[]),{updateSettings:t}=(0,N.useDispatch)(a.A.GLOBAL_SETTINGS),n=(0,l.useMemo)(()=>{var M;const t=null!==(M=e?.login_registration)&&void 0!==M?M:ne;return{login:Ne(t.login),registration:Ne(t.registration)}},[e?.login_registration]),[o,c]=(0,l.useState)(n);(0,l.useEffect)(()=>{c(n)},[n]),(0,l.useEffect)(()=>{(0,N.resolveSelect)("formgent").fetchPages?.()},[]);const r=async e=>{const M={...o,...e};c(M);try{await t({login_registration:M}),(0,i.doAction)("formgent-toast",{message:(0,g.__)("Settings have been updated successfully.","formgent"),type:"success"})}catch(e){console.error(e)}};return(0,s.jsxs)("div",{className:"formgent-settings-content",children:[(0,s.jsx)("div",{className:"formgent-settings-content__head",children:(0,s.jsx)("h4",{className:"formgent-settings-content__title",children:(0,g.__)("Login/Registration","formgent")})}),M?(0,s.jsx)(D.AntSkeleton,{active:!0}):(0,s.jsxs)("div",{className:"formgent-settings-content__item",children:[(0,s.jsxs)("div",{className:"formgent-settings-content__toggle formgent-mb-20",children:[(0,s.jsx)(D.Toggle,{title:(0,g.__)("Enable Custom Login Page","formgent"),description:(0,g.__)("Enable this to assign your Custom Login page and offer a personalized log-in experience.","formgent"),checked:"1"===o.login.status,onChange:e=>{r({login:{...o.login,status:e?"1":"0"}})}}),"1"===o.login.status&&(0,s.jsx)("div",{className:"formgent-page-selection-wrapper formgent-mt-15 formgent-mb-30",children:(0,s.jsx)("div",{className:"formgent-settings-page-configuration",children:(0,s.jsxs)("div",{className:"formgent-settings-content__field",children:[(0,s.jsx)("span",{className:"formgent-settings-content__field-label",children:(0,g.__)("Login page","formgent")}),(0,s.jsx)(D.WPPages,{handleInputChange:(e,M)=>{r({login:{...o.login,page:null!=M?M:""}})},pageSelected:o.login.page})]})})})]}),(0,s.jsxs)("div",{className:"formgent-settings-content__toggle formgent-mb-20",children:[(0,s.jsx)(D.Toggle,{title:(0,g.__)("Enable Custom Registration Page","formgent"),description:(0,g.__)("Enable this to assign your Custom Registration page and offer a personalized sign-up experience.","formgent"),checked:"1"===o.registration.status,onChange:e=>{r({registration:{...o.registration,status:e?"1":"0"}})}}),"1"===o.registration.status&&(0,s.jsx)("div",{className:"formgent-page-selection-wrapper formgent-mt-15",children:(0,s.jsx)("div",{className:"formgent-settings-page-configuration",children:(0,s.jsxs)("div",{className:"formgent-settings-content__field",children:[(0,s.jsx)("span",{className:"formgent-settings-content__field-label",children:(0,g.__)("Registration page","formgent")}),(0,s.jsx)(D.WPPages,{handleInputChange:(e,M)=>{r({registration:{...o.registration,page:null!=M?M:""}})},pageSelected:o.registration.page})]})})})]})]})]})}const ge=z.Ay.div`
	border-radius: 10px;
	border: 1px solid var( --formgent-color-gray-200 );
	background: #fff;
	box-shadow: 0px 1px 2px 0px rgba( 16, 24, 40, 0.05 );
...
`,z.Ay.div`
    ...
    .formgent-user-registration-no-block-notice{
        display: flex;
        align-items: flex-start;
        gap: 12px;
        padding: 12px 16px;
        margin-bottom: 20px;
        border-radius: 8px;
        background-color: var(--formgent-color-info-50, #eff6ff);
        border: 1px solid var(--formgent-color-info-200, #bfdbfe);
        svg{
            width: 20px;
            height: 20px;
            min-width: 20px;
        ...
        p{
            ...
            font-size: 14px;
            line-height: 1.5;
            color: var(--formgent-color-gray-700, #374151);
        }
    }
`,z.Ay.div`
...
`,z.Ay.div`
    ...
    .formgent-form-settings-form-content {
		width: 100%;
		max-width: 908px;
		margin: 0 auto;
        @media only screen and (max-width: 1280px){
    ...
    /* User Registration */
    .formgent-add-user-registration-wrapper{
        #formgent-user-registration-form{
            margin-top: 22px;
        }
        .ant-form-item-label{
            label{
        ...
        .formgent-user-registration-manual-verification-info{
            margin: -4px 0 24px;
            .ant-alert{
                border-radius: 8px;
            }
...
`,z.Ay.div`
    ...
    .formgent-mapping-table{
        &.formgent-mapping-table--fixed{
            .formgent-mapping-table-column{
                width: 50%;
                &:last-child,
                &:first-child{
...
`,z.Ay.div`
    ...
    .ant-table-thead >tr>th.formgent-table-head-action{
        text-align: end;
    }
    ...
    .formgent-action-link-group{
        justify-content: flex-end;
    }
`;var je=t(48147);function se(e){const{useLocation:M,navItems:t}=e,n=M().pathname.split("settings/")[1],N=e=>{const M=e.replace(/\//g,"");return n===M},i=e=>{for(const M of e){if(N(M.path))return M;if(M.children){const e=i(M.children);if(e)return e}}return null},g=i(t),o=g?.path.replace(/\//g,""),a=g?.path?.split("/")[0];return(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(De,{className:"formgent-settings-sider",children:(0,s.jsx)(D.AntMenu,{defaultSelectedKeys:[o||"general-settings"],defaultOpenKeys:[a],mode:"inline",items:t,className:"formgent-settings-sider__nav"})}),(0,s.jsx)("div",{className:"formgent-editor-wrap__content__main",children:(0,s.jsx)(je.sv,{})})]})}function Te(){const{validation_messages:e,loading:M}=(0,N.useSelect)(e=>{const{getValidationMessages:M,isLoading:t}=e(a.A.GLOBAL_SETTINGS);return{validation_messages:M(),loading:t()}},[]),{updateValidationMessages:t,updateSettings:n}=(0,N.useDispatch)(a.A.GLOBAL_SETTINGS),[o]=D.AntForm.useForm(),[c,r]=(0,l.useState)({});(0,l.useEffect)(()=>{e&&(r(e),o.setFieldsValue(e))},[e,o]);const j=[{name:"required",title:(0,g.__)("Required Field","formgent"),placeholder:(0,g.__)("This field is required","formgent")},{name:"email",title:(0,g.__)("Email","formgent"),placeholder:(0,g.__)("This field must contain a valid email","formgent")},{name:"number",title:(0,g.__)("Number","formgent"),placeholder:(0,g.__)("This field must contain numeric value","formgent")},{name:"min",title:(0,g.__)("Minimum Value","formgent"),placeholder:(0,g.__)("This value is below the minimum limit","formgent")},{name:"max",title:(0,g.__)("Maximum Value","formgent"),placeholder:(0,g.__)("This value exceeds the maximum limit","formgent")},{name:"confirm",title:(0,g.__)("Confirm Value","formgent"),placeholder:(0,g.__)("Field values do not match","formgent")},{name:"url",title:(0,g.__)("URL Format Validation","formgent"),placeholder:(0,g.__)("Please enter a valid URL","formgent")},{name:"input_mask",title:(0,g.__)("Input Mask Error","formgent"),placeholder:(0,g.__)("Please fill out the field in required format","formgent")},{name:"gdpr",title:(0,g.__)("GDPR Compliance (Checkbox)","formgent"),placeholder:(0,g.__)("You must agree to proceed","formgent")},{name:"character_limit",title:(0,g.__)("Character Limit","formgent"),placeholder:(0,g.__)("Limit is {limit} characters","formgent")}];return(0,s.jsxs)("div",{className:"formgent-settings-content",children:[(0,s.jsx)("div",{className:"formgent-settings-content__head",children:(0,s.jsx)("h4",{className:"formgent-settings-content__title",children:(0,g.__)("Validation Messages","formgent")})}),(0,s.jsx)("div",{className:"formgent-settings-content__item formgent-mb-40",children:M?(0,s.jsx)(D.AntSkeleton,{active:!0}):(0,s.jsxs)(D.AntForm,{form:o,layout:"vertical",className:"formgent-settings-content__validation-messages",onFinish:()=>{!async function(e){(0,i.doAction)("formgent_update_global_settings",e,c,r,"validation_messages",t,n)}(c)},children:[j.map(e=>(0,s.jsx)("div",{className:"formgent-form-group",children:(0,s.jsx)(D.AntFormItem,{label:e.title,name:e.name,rules:[{required:!0,message:(0,g.__)("The field is required","formgent")}],children:(0,s.jsx)(D.AntInput,{className:"formgent-form-field",placeholder:e.placeholder,onChange:M=>{return t=e.name,n=M.target.value,void r(e=>({...e,[t]:n}));var t,n}})})},e.name)),(0,s.jsx)("div",{className:"formgent-form-group",children:(0,s.jsx)(D.AntButton,{type:"primary",className:"formgent-save-settings-btn",htmlType:"submit",children:(0,g.__)("Save Changes","formgent")})})]})})]})}var de=t(15784),Ie=t(92811),me=t(45506);const xe=z.Ay.div`
    width: 100%;
    max-width: 1040px;
    box-sizing: border-box;
    padding-bottom: 60px;

    .formgent-mcp-page-head {
        margin-bottom: 24px;
    }
    ...
    .formgent-mcp-gate {
        ...
        border: 1px solid var(--formgent-color-gray-200);
        border-radius: 10px;
        background: var(--formgent-color-white);
    ...
    .formgent-mcp-gate h5,
    .formgent-mcp-panel h5 {
        margin: 0;
        color: var(--formgent-color-gray-900);
        font-size: 16px;
        font-weight: 600;
	...
	.formgent-mcp-download-button,
	.formgent-mcp-download-button:hover,
	.formgent-mcp-download-button:focus,
	.formgent-mcp-download-button:focus-visible,
	.formgent-mcp-download-button:active {
		color: var(--formgent-color-white) !important;
	}

	.formgent-mcp-download-button svg {
		color: var(--formgent-color-white);
		fill: currentColor;
	}

    .formgent-mcp-gate > p,
    .formgent-mcp-panel-head p {
        margin: 6px 0 0;
        color: var(--formgent-color-gray-600);
        font-size: 13px;
        line-height: 1.6;
    ...
    .formgent-mcp-gate--error {
        border-color: #fecaca;
        background: #fffafa;
    }

    .formgent-mcp-actions,
    .formgent-mcp-gate .formgent-ant-button-wrapper {
        display: inline-flex;
        align-items: center;
        gap: 14px;
    }
    ...
    .formgent-mcp-panel-head {
        max-width: 820px;
    }

    .formgent-mcp-permissions {
        margin-top: 18px;
        border-top: 1px solid var(--formgent-color-gray-100);
    }

    .formgent-mcp-permission {
        border-bottom: 1px solid var(--formgent-color-gray-100);
    }

    .formgent-mcp-permission:last-child {
        border-bottom: 0;
    }

    .formgent-mcp-permission .formgent-settings-toggle {
        width: 100%;
        max-width: none;
        margin: 0;
        padding: 18px 0;
    ...
    .formgent-mcp-permission .formgent-settings-toggle-action {
        padding-top: 1px;
    }

    .formgent-mcp-permission .formgent-settings-toggle-info-content h3 {
        color: var(--formgent-color-gray-900);
        font-size: 14px;
        font-weight: 600;
        line-height: 1.45;
    ...
    .formgent-mcp-permission .formgent-settings-toggle-info-content span {
        max-width: 760px;
        margin-top: 5px;
        color: var(--formgent-color-gray-500);
        font-size: 13px;
    ...
    .formgent-mcp-connect {
        margin-top: 20px;
    }

    .formgent-mcp-connect-steps {
        margin: 22px 0;
        padding-left: 24px;
    }

    .formgent-mcp-connect-steps li {
        margin: 10px 0;
        padding-left: 3px;
        color: var(--formgent-color-gray-700);
        font-size: 13px;
    ...
    .formgent-mcp-connect-steps li:first-child span {
        margin-right: 7px;
    }
    ...
    .formgent-mcp-link:hover {
        color: var(--formgent-color-primary);
        text-decoration: underline;
    }

    .formgent-mcp-client-field {
        margin-bottom: 18px;
    }

    .formgent-mcp-client-field label,
    .formgent-mcp-field-label {
        display: block;
        margin-bottom: 8px;
        color: var(--formgent-color-gray-900);
        font-size: 13px;
    ...
    .formgent-mcp-client-field .formgent-ant-select,
    .formgent-mcp-client-field .ant-select {
        width: 100%;
    }
    ...
    .formgent-mcp-client-field .ant-select-selector {
    ...
    .formgent-mcp-client-field .ant-select-selection-item {
        height: auto;
        line-height: normal;
    }

    .formgent-mcp-endpoint {
        display: flex;
    ...
    .formgent-mcp-endpoint > div:first-child {
        flex: 1;
        min-width: 0;
    }

    .formgent-mcp-endpoint code {
        display: block;
        box-sizing: border-box;
        width: 100%;
        min-height: 42px;
    ...
    .formgent-mcp-endpoint .ant-btn {
        height: 42px;
    }

    .formgent-mcp-config-wrap {
        position: relative;
        margin-top: 18px;
    }
    ...
    .formgent-mcp-config--compact {
        min-height: 78px;
        max-height: none;
    }

    .formgent-mcp-config code {
        background: transparent;
        padding: 0;
        color: inherit;
        font: inherit;
    ...
    .formgent-mcp-copy-trigger--compact {
        position: absolute;
        top: 12px;
        right: 12px;
    }

    .formgent-mcp-icon-button.ant-btn {
        display: inline-flex;
        align-items: center;
        justify-content: center;
        width: 38px;
    ...
    .formgent-mcp-icon-button svg {
        width: 17px;
        height: 17px;
    }

    .formgent-mcp-config-note {
        margin: 10px 0 0;
        color: var(--formgent-color-gray-500);
        font-size: 12px;
        line-height: 1.6;
    ...
    .formgent-mcp-client-config {
        margin-top: 18px;
    }

    .formgent-mcp-config-placement .formgent-mcp-field-label {
        margin-bottom: 4px;
    }

    .formgent-mcp-config-placement .formgent-mcp-config-note {
        margin-top: 0;
    }

    .formgent-mcp-config-locations {
        margin: 7px 0 0;
        padding: 0;
        list-style: none;
    }

    .formgent-mcp-config-locations li {
        margin-top: 4px;
        color: var(--formgent-color-gray-600);
        font-size: 12px;
        line-height: 1.6;
    ...
    .formgent-mcp-config-locations code {
        padding: 0;
        background: transparent;
        color: var(--formgent-color-gray-700);
        font-size: inherit;
    ...
    .formgent-mcp-client-config > .formgent-mcp-config-wrap {
        margin-top: 12px;
    }

    .formgent-mcp-codex-config {
        margin-top: 18px;
    }

    .formgent-mcp-config-section + .formgent-mcp-config-section {
        margin-top: 22px;
        padding-top: 22px;
        border-top: 1px solid var(--formgent-color-gray-100);
    }

    .formgent-mcp-config-section .formgent-mcp-config-note {
        margin-top: -2px;
    }

    .formgent-mcp-config-section .formgent-mcp-config-wrap {
        margin-top: 10px;
    }

    .formgent-mcp-config-note--final {
        margin-top: 14px;
    }
...
`,ze={chatgpt_codex:(0,g.__)("ChatGPT desktop / Codex","formgent"),claude_desktop:(0,g.__)("Claude Desktop","formgent"),claude_code:(0,g.__)("Claude Code","formgent"),cursor:(0,g.__)("Cursor","formgent"),vscode:(0,g.__)("VS Code","formgent"),continue:(0,g.__)("Continue","formgent"),generic:(0,g.__)("Generic MCP client","formgent")},Ue={claude_desktop:{title:(0,g.__)("Claude Desktop configuration","formgent"),description:(0,g.__)("Copy the JSON configuration below into the file for your operating system:","formgent"),locations:[{label:(0,g.__)("macOS","formgent"),value:"~/Library/Application Support/Claude/claude_desktop_config.json"},{label:(0,g.__)("Windows","formgent"),value:"%APPDATA%\\Claude\\claude_desktop_config.json"}],final:(0,g.__)("Replace the credential placeholders, save the file, then fully restart Claude Desktop.","formgent")},claude_code:{title:(0,g.__)("Claude Code project configuration","formgent"),description:(0,g.__)("Save the JSON configuration below as this file in your project root:","formgent"),locations:[{value:".mcp.json"}],final:(0,g.__)("Replace the credential placeholders, restart Claude Code, and approve the project server when prompted. Because the file contains credentials, do not commit it to version control.","formgent")},cursor:{title:(0,g.__)("Cursor configuration","formgent"),description:(0,g.__)("Copy the JSON configuration below into one of these files:","formgent"),locations:[{label:(0,g.__)("Current project","formgent"),value:".cursor/mcp.json"},{label:(0,g.__)("All projects","formgent"),value:"~/.cursor/mcp.json"}],final:(0,g.__)("Replace the credential placeholders, save the file, then restart Cursor.","formgent")},vscode:{title:(0,g.__)("VS Code MCP configuration","formgent"),description:(0,g.__)("Use either the workspace file or the user-wide MCP configuration:","formgent"),locations:[{label:(0,g.__)("Current workspace","formgent"),value:".vscode/mcp.json"},{label:(0,g.__)("User-wide","formgent"),value:(0,g.__)("Run “MCP: Open User Configuration”","formgent")}],final:(0,g.__)("Replace the credential placeholders, save the file, then start or restart the FormGent server from VS Code’s MCP controls.","formgent")},continue:{title:(0,g.__)("Continue project configuration","formgent"),description:(0,g.__)("Save the JSON configuration below as this file in your project root:","formgent"),locations:[{value:".continue/mcpServers/formgent.json"}],final:(0,g.__)("Replace the credential placeholders, save the file, then reload Continue and use Agent mode.","formgent")},generic:{title:(0,g.__)("MCP client configuration","formgent"),description:(0,g.__)("Add the JSON configuration below to your client’s stdio MCP server settings. The exact file location depends on the client.","formgent"),locations:[],final:(0,g.__)("Replace the credential placeholders before connecting, then restart or reload your client.","formgent")}};function ue({value:e,label:M,compact:t=!1}){const[n,N]=(0,l.useState)(!1),o=(0,m.useCopyToClipboard)(e,()=>{N(!0),(0,i.doAction)("formgent-toast",{message:(0,g.__)("Copied to clipboard.","formgent"),type:"success"}),setTimeout(()=>N(!1),2500)});return(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)("span",{ref:o,className:t?"formgent-mcp-copy-trigger--compact":void 0,children:(0,s.jsx)(D.AntButton,{"aria-label":M,className:t?"formgent-mcp-icon-button":"",icon:t?(0,s.jsx)(de.A,{icon:Ie.A}):null,children:t?null:M})}),(0,s.jsx)("span",{className:"formgent-mcp-screen-reader","aria-live":"polite",children:n?(0,g.__)("Copied.","formgent"):""})]})}function ye({value:e,label:M,compact:t=!1}){return(0,s.jsxs)("div",{className:"formgent-mcp-config-wrap",children:[(0,s.jsx)("pre",{className:"formgent-mcp-config"+(t?" formgent-mcp-config--compact":""),tabIndex:"0",children:(0,s.jsx)("code",{children:e})}),(0,s.jsx)(ue,{value:e,label:M,compact:!0})]})}function Ae({client:e,config:M}){if("codex"===M.kind)return(0,s.jsxs)("div",{className:"formgent-mcp-codex-config",children:[(0,s.jsxs)("div",{className:"formgent-mcp-config-section",children:[(0,s.jsx)("span",{className:"formgent-mcp-field-label",children:(0,g.__)("Codex CLI command","formgent")}),(0,s.jsx)("p",{className:"formgent-mcp-config-note",children:(0,g.__)("Replace the credential placeholders, then run this command in a terminal.","formgent")}),(0,s.jsx)(ye,{value:M.cli,label:(0,g.__)("Copy Codex CLI command","formgent"),compact:!0})]}),(0,s.jsxs)("div",{className:"formgent-mcp-config-section",children:[(0,s.jsx)("span",{className:"formgent-mcp-field-label",children:(0,g.__)("Codex config.toml","formgent")}),(0,s.jsx)("p",{className:"formgent-mcp-config-note",children:(0,g.__)("Or add this block to ~/.codex/config.toml after replacing the credential placeholders.","formgent")}),(0,s.jsx)(ye,{value:M.toml,label:(0,g.__)("Copy Codex TOML configuration","formgent")})]}),(0,s.jsx)("p",{className:"formgent-mcp-config-note formgent-mcp-config-note--final",children:(0,g.__)("Restart ChatGPT desktop, Codex CLI, or the Codex IDE extension after saving the configuration.","formgent")})]});const t=JSON.stringify(M.content,null,2),n=Ue[e]||Ue.generic;return(0,s.jsxs)("div",{className:"formgent-mcp-client-config",children:[(0,s.jsxs)("div",{className:"formgent-mcp-config-placement",children:[(0,s.jsx)("span",{className:"formgent-mcp-field-label",children:n.title}),(0,s.jsx)("p",{className:"formgent-mcp-config-note",children:n.description}),n.locations.length>0&&(0,s.jsx)("ul",{className:"formgent-mcp-config-locations",children:n.locations.map(e=>(0,s.jsxs)("li",{children:[e.label&&(0,s.jsxs)("span",{children:[e.label,": "]}),(0,s.jsx)("code",{children:e.value})]},`${e.label||""}${e.value}`))})]}),(0,s.jsx)(ye,{value:t,label:(0,g.__)("Copy configuration","formgent")}),(0,s.jsx)("p",{className:"formgent-mcp-config-note",children:n.final}),(0,s.jsx)("p",{className:"formgent-mcp-config-note",children:(0,g.__)('For local HTTPS sites, add "NODE_USE_SYSTEM_CA": "1" inside the env object, then fully restart the client.',"formgent")})]})}function Ee({status:e,isSaving:M,activateAdapter:t,reload:n}){return["unavailable","action_required_install","action_required_activate","error"].includes(e.state)?"unavailable"===e.state?(0,s.jsxs)("section",{className:"formgent-mcp-gate",role:"status",children:[(0,s.jsx)("h5",{children:(0,g.__)("Update WordPress to continue","formgent")}),(0,s.jsx)("p",{children:(0,g.__)("FormGent AI connections require the WordPress Abilities API. Update WordPress, then return to this page.","formgent")})]}):"action_required_install"===e.state?(0,s.jsxs)("section",{className:"formgent-mcp-gate",role:"status",children:[(0,s.jsx)("h5",{children:(0,g.__)("Install the MCP Adapter","formgent")}),(0,s.jsx)("p",{children:(0,g.__)("The official MCP Adapter connects compatible AI clients to WordPress abilities.","formgent")}),(0,s.jsxs)("ol",{className:"formgent-mcp-steps",children:[(0,s.jsx)("li",{children:(0,g.__)("Download the latest MCP Adapter release.","formgent")}),(0,s.jsx)("li",{children:(0,g.__)("Open Plugins > Add New Plugin > Upload Plugin.","formgent")}),(0,s.jsx)("li",{children:(0,g.__)("Install and activate the uploaded plugin.","formgent")})]}),(0,s.jsx)(D.AntButton,{className:"formgent-mcp-download-button",type:"primary",href:e.adapter_install_url,target:"_blank",rel:"noreferrer",icon:(0,s.jsx)(de.A,{icon:me.A}),children:(0,g.__)("Download MCP Adapter","formgent")})]}):"action_required_activate"===e.state?(0,s.jsxs)("section",{className:"formgent-mcp-gate",role:"status",children:[(0,s.jsx)("h5",{children:(0,g.__)("Activate the MCP Adapter","formgent")}),(0,s.jsx)("p",{children:(0,g.__)("The MCP Adapter is installed but inactive. Activate it to configure FormGent AI connections.","formgent")}),(0,s.jsx)(D.AntButton,{type:"primary",loading:M,onClick:t,children:(0,g.__)("Activate MCP Adapter","formgent")})]}):(0,s.jsxs)("section",{className:"formgent-mcp-gate formgent-mcp-gate--error",role:"alert",children:[(0,s.jsx)("h5",{children:(0,g.__)("MCP setup needs attention","formgent")}),(0,s.jsx)("p",{children:(0,g.__)("Update the MCP Adapter to a compatible version, then check the setup again.","formgent")}),(0,s.jsxs)("div",{className:"formgent-mcp-actions",children:[(0,s.jsx)(D.AntButton,{type:"primary",onClick:n,children:(0,g.__)("Check setup again","formgent")}),(0,s.jsx)("a",{className:"formgent-mcp-link",href:e.adapter_install_url,target:"_blank",rel:"noreferrer",children:(0,g.__)("Get the latest adapter","formgent")})]})]}):null}function Qe(){const e=(0,N.useSelect)(e=>e(a.A.MCP).getMcp(),[]),{updateSetting:M,activateAdapter:t,reload:n}=(0,N.useDispatch)(a.A.MCP),[o,c]=(0,l.useState)("chatgpt_codex"),{settings:r,status:j,clients:T,isLoading:d,isSaving:I,error:m}=e,x=e=>{(0,i.doAction)("formgent-toast",{message:e?.message||(0,g.__)("The AI connection setting could not be changed.","formgent"),type:"error"})},z="unavailable"===j.state,U=["unavailable","action_required_install","action_required_activate"].includes(j.state),u=[{key:"enabled",title:(0,g.__)("Enable FormGent abilities","formgent"),description:(0,g.__)("Register FormGent tools with the WordPress Abilities API. Existing forms and submissions are not changed.","formgent")},{key:"response_data",title:(0,g.__)("Allow response data access","formgent"),description:(0,g.__)("Allow administrators to read bounded submission data. Passwords, payment fields, and other sensitive values remain redacted.","formgent")},{key:"writes",title:(0,g.__)("Allow create and update operations","formgent"),description:(0,g.__)("Allow authorized clients to create and update forms, safe settings, and response state.","formgent")},{key:"deletes",title:(0,g.__)("Allow delete operations","formgent"),description:(0,g.__)("Allow form deletion and permanent response deletion. Deleted response data cannot be recovered.","formgent")},{key:"server",title:(0,g.__)("Enable MCP server","formgent"),description:(0,g.__)("Create a dedicated authenticated FormGent endpoint for compatible clients such as ChatGPT desktop, Codex, Claude, Cursor, and VS Code.","formgent")}],y=r.enabled?u:u.filter(e=>"enabled"===e.key),A=Object.keys(ze).filter(e=>T[e]),E=T[o]?o:A[0],Q=A.map(e=>({value:e,label:ze[e]}));return(0,s.jsxs)(xe,{className:"formgent-settings-content",children:[(0,s.jsx)("header",{className:"formgent-mcp-page-head",children:(0,s.jsxs)("div",{children:[(0,s.jsx)("h4",{className:"formgent-settings-content__title",children:(0,g.__)("MCP","formgent")}),(0,s.jsx)("p",{className:"formgent-mcp-intro",children:(0,g.__)("Connect FormGent to AI clients with WordPress authentication and explicit, least-privilege controls.","formgent")})]})}),d?(0,s.jsx)(D.AntSkeleton,{active:!0,paragraph:{rows:8}}):(0,s.jsxs)(s.Fragment,{children:[m&&(0,s.jsxs)("div",{className:"formgent-mcp-alert formgent-mcp-alert--error",role:"alert",children:[(0,s.jsx)("span",{children:m}),(0,s.jsx)("button",{type:"button",className:"button-link",onClick:n,children:(0,g.__)("Retry","formgent")})]}),(0,s.jsx)(Ee,{status:j,isSaving:I,activateAdapter:async()=>{try{const e=await t();(0,i.doAction)("formgent-toast",{message:e?.message||(0,g.__)("The MCP Adapter has been activated.","formgent"),type:"success"})}catch(e){x(e)}},reload:n}),!U&&(0,s.jsxs)(s.Fragment,{children:[(0,s.jsxs)("section",{className:"formgent-mcp-panel","aria-labelledby":"formgent-mcp-permissions-title",children:[(0,s.jsx)("div",{className:"formgent-mcp-panel-head",children:(0,s.jsxs)("div",{children:[(0,s.jsx)("h5",{id:"formgent-mcp-permissions-title",children:(0,g.__)("Access and permissions","formgent")}),(0,s.jsx)("p",{children:(0,g.__)("Enable only the access your AI workflow needs. Every action also checks the connected WordPress user’s capabilities.","formgent")})]})}),(0,s.jsx)("div",{className:"formgent-mcp-permissions",children:y.map(e=>(0,s.jsx)("div",{className:"formgent-mcp-permission",children:(0,s.jsx)(D.Toggle,{title:e.title,description:e.description,checked:Boolean(r[e.key]),disabled:z||I,"aria-label":e.title,onChange:t=>(async(e,t)=>{try{await M(e,t),(0,i.doAction)("formgent-toast",{message:(0,g.__)("AI connection setting saved.","formgent"),type:"success"})}catch(e){x(e)}})(e.key,t)})},e.key))})]}),j.server_active&&E&&(0,s.jsxs)("section",{className:"formgent-mcp-panel formgent-mcp-connect","aria-labelledby":"formgent-mcp-client-title",children:[(0,s.jsx)("div",{className:"formgent-mcp-panel-head",children:(0,s.jsxs)("div",{children:[(0,s.jsx)("h5",{id:"formgent-mcp-client-title",children:(0,g.__)("Connect your AI client","formgent")}),(0,s.jsx)("p",{children:(0,g.__)("Use a separate FormGent MCP Operator user and Application Password, then copy the configuration into your client.","formgent")})]})}),(0,s.jsxs)("ol",{className:"formgent-mcp-connect-steps",children:[(0,s.jsxs)("li",{children:[(0,s.jsx)("span",{children:(0,g.__)("Create a separate WordPress user with the FormGent MCP Operator role, then create an Application Password from that user’s profile.","formgent")}),(0,s.jsx)("a",{className:"formgent-mcp-link",href:j.application_password_url,children:(0,g.__)("Open Application Passwords","formgent")})]}),(0,s.jsx)("li",{children:(0,g.__)("Select your AI client and follow the placement instructions shown below.","formgent")}),(0,s.jsx)("li",{children:(0,g.__)("Replace the username and Application Password placeholders, then restart your client.","formgent")})]}),(0,s.jsxs)("div",{className:"formgent-mcp-client-field",children:[(0,s.jsx)("label",{htmlFor:"formgent-mcp-client-select",children:(0,g.__)("AI client","formgent")}),(0,s.jsx)(D.AntSelect,{id:"formgent-mcp-client-select",value:E,onChange:c,options:Q,popupClassName:"formgent-mcp-client-menu"})]}),(0,s.jsxs)("div",{className:"formgent-mcp-endpoint",children:[(0,s.jsxs)("div",{children:[(0,s.jsx)("span",{className:"formgent-mcp-field-label",children:(0,g.__)("MCP endpoint","formgent")}),(0,s.jsx)("code",{tabIndex:"0",children:j.endpoint})]}),(0,s.jsx)(ue,{value:j.endpoint,label:(0,g.__)("Copy endpoint","formgent")})]}),j.https_warning&&(0,s.jsx)("div",{className:"formgent-mcp-alert",role:"note",children:(0,g.__)("Use HTTPS before connecting a remote client so credentials are encrypted in transit.","formgent")}),(0,s.jsx)(Ae,{client:E,config:T[E]})]})]})]})]})}function pe(){const{CommonReducer:e}=(0,N.useSelect)(e=>e("formgent").getCommonState(),[]);(0,N.useSelect)(e=>{e(a.A.GLOBAL_SETTINGS).getSettings()},[]),(0,i.hasAction)("formgent_update_global_settings","formgent")||(0,i.addAction)("formgent_update_global_settings","formgent",async(e,M,t,n,N,o)=>{const a={...M,...e};t(a);try{await o({[n]:a}),N(a),(0,i.doAction)("formgent-toast",{message:(0,g.__)((0,g.__)("Settings have been updated successfully.","formgent"),"formgent"),type:"success"})}catch(e){console.error(e)}});const{Route:M,Routes:t,NavLink:l,useNavigate:r,useLocation:j}=e.routerComponents,T=(0,i.applyFilters)("formgent_global_settings_routes",[{key:"general-settings",label:(0,s.jsx)(je.N_,{to:"/settings",children:(0,g.__)("General Settings","formgent")}),icon:(0,s.jsx)(x.A,{src:"data:image/svg+xml;base64,"}),path:"/",element:(0,s.jsx)(te,{})},{key:"security-settings",label:(0,s.jsx)(je.N_,{to:"/settings/security-settings",children:(0,g.__)("Security & Protection","formgent")}),icon:(0,s.jsx)(x.A,{src:"data:image/svg+xml;base64,"}),path:"/security-settings",element:(0,s.jsx)(re,{})},{key:"validation-settings",label:(0,s.jsx)(je.N_,{to:"/settings/validation-settings",children:(0,g.__)("Validation","formgent")}),icon:(0,s.jsx)(x.A,{src:"data:image/svg+xml;base64,"}),path:"/validation-settings",element:(0,s.jsx)(Te,{})},{key:"login-registration",label:(0,s.jsx)(je.N_,{to:"/settings/login-registration",children:(0,g.__)("Login/Registration","formgent")}),icon:(0,s.jsx)(x.A,{src:"data:image/svg+xml;base64,"}),path:"/login-registration",element:(0,s.jsx)(ie,{})},{key:"ai-connections",label:(0,s.jsx)(je.N_,{to:"/settings/ai-connections",children:(0,g.__)("MCP","formgent")}),icon:(0,s.jsx)(x.A,{src:"data:image/svg+xml;base64,"}),path:"/ai-connections",element:(0,s.jsx)(Qe,{})},{key:"integrations",label:(0,s.jsx)(je.N_,{to:"/settings/integrations",children:(0,g.__)("Integrations","formgent")}),icon:(0,s.jsx)(x.A,{src:"data:image/svg+xml;base64,"}),path:"/integrations",element:(0,s.jsx)(h,{})},{key:"payments",label:(0,s.jsx)(je.N_,{to:"/settings/payments",children:(0,g.__)("Payment Settings","formgent")}),icon:(0,s.jsx)(x.A,{src:"data:image/svg+xml;base64,"}),path:"/payments",element:(0,s.jsx)(_,{})}]),d=(0,c.LB)();T.push({key:"sms-settings",label:(0,s.jsx)(je.N_,{to:"/settings/sms-settings",children:(0,g.__)("SMS Gateway","formgent")}),icon:(0,s.jsx)(x.A,{src:"data:image/svg+xml;base64,"}),path:"/sms-settings",element:d?(0,s.jsx)(q.Slot,{children:e=>(0,s.jsx)(s.Fragment,{children:e})}):(0,s.jsx)(Z,{className:"formgent-settings-content",children:(0,s.jsx)(Me,{title:(0,g.__)("Try FormGent Pro","formgent"),subtitle:(0,g.__)("100% Risk-Free Money Back Guarantee!","formgent"),description:(0,g.__)("Upgrade to unlock SMS Gateway settings and access many other powerful features.","formgent"),buttonValue:(0,g.__)("Upgrade Now","formgent"),classNames:"formgent-settings-sms-gateway-cta"})})}),d&&T.push({key:"license-settings",label:(0,s.jsx)(je.N_,{to:"/settings/license-settings",children:(0,g.__)("Activate License","formgent")}),icon:(0,s.jsx)(x.A,{src:"data:image/svg+xml;base64,"}),path:"/license-settings",element:(0,s.jsx)(K.Slot,{children:e=>(0,s.jsx)(s.Fragment,{children:e})})});const I=()=>(0,o.getPlugins)().map((e,M)=>{const t=e.render;return(0,s.jsx)(t,{},M)});return(0,s.jsxs)(n.SlotFillProvider,{children:[(0,s.jsx)(I,{}),(0,s.jsxs)("div",{className:"formgent-editor-wrap",children:[(0,s.jsx)(D.Navbar,{}),(0,s.jsx)(F,{className:"formgent-editor-wrap__content",children:(0,s.jsx)(t,{children:(0,s.jsx)(M,{path:"/",element:(0,s.jsx)(se,{NavLink:l,useNavigate:r,useLocation:j,navItems:T}),children:T.map(e=>(0,s.jsx)(M,{path:e.path,element:e.element},e.key))})})})]})]})}}}]);